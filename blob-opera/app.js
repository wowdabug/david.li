!(function (e) {
    ...
    if (0 !== n)
      if (n) t.push(n[2]);
        ...
        ((s.charset = "utf-8"),
          ...
          (s.src = (function (e) {
            return (
              o.p + "" + ({ 0: "Axl", 4: "audioworkletaudio" }[e] || e) + ".js"
            );
          })(e)));
        var l = new Error();
        r = function (t) {
  ...
  function (e, t, n) {
    ...
    function p(e) {
      return (
        e === o.b.a || e === o.b.e || e === o.b.i || e === o.b.o || e === o.b.u
      );
    }
    var m = [0, 0, 0];
    ...
    function b(e, t, n) {
      ...
      for (a = 0; a < o.length; ++a)
        (m.push(o[a][0]), m.push(o[a][1]), m.push(o[a][2]));
      return m;
    }
    function v(e) {
    ...
    var a = {
      ...
      clampedMix: function (e, t, n, i, o) {
        var r = a.subtract([], n, t),
          ...
          l = Math.min(s * i, o);
        (l > 0
          ? a.add(e, t, a.multiplyByScalar([], r, l / s))
      ...
      slerp: function (e, t, n, i) {
        ...
        for (
          var s = Math.acos(r) * i,
            l = a.subtract([], n, a.multiplyByScalar([], t, r)),
            u = 0;
          u < 3;
          ++u
        )
  ...
  function (e, t, n) {
    ...
    var i = {
      ...
      normalize: function (e, t) {
        var n =
          1 / Math.sqrt(t[0] * t[0] + t[1] * t[1] + t[2] * t[2] + t[3] * t[3]);
        return (
          (e[0] = t[0] * n),
          (e[1] = t[1] * n),
          (e[2] = t[2] * n),
  ...
  function (e, t, n) {
    ...
    var i = (function () {
      function e(e) {
        ((this.buffer = e),
          (this.floatView = new Float32Array(e)),
  ...
  function (e, t, n) {
    ...
    function a(e) {
      ...
      for (
        ...
        var s = r[a];
        for (n = 0; n < 60; ++n)
          t[n] += o(i[n], s.centreFrequencyHz, s.bandwidthOctaves, s.gainDB);
      }
      return t;
    }
    var r = {
  ...
  function (e, t, n) {
    ...
    ((h.create = d()),
      ...
      (h.prototype._push = function (e, t, n) {
        return (
          (this.tail = this.tail.next = new l(e, t, n)),
          (this.len += t),
          this
        );
      }),
  ...
  function (e, t, n) {
    ...
    ((l.create = h()),
      ...
      (l.prototype.uint32 =
        ...
        function () {
          if (
            ((u = (127 & this.buf[this.pos]) >>> 0), this.buf[this.pos++] < 128)
          )
            return u;
          if (
    ...
    ((s.JitterTemplates = (function () {
      ...
      return (
        ...
        (e.encode = function (e, t) {
          if (
            (t || (t = a.create()), null != e.templates && e.templates.length)
          )
            for (var n = 0; n < e.templates.length; ++n)
              s.JitterTemplates.Template.encode(
                e.templates[n],
                t.uint32(10).fork(),
              ).ldelim();
          return t;
            ...
            switch (a >>> 3) {
              case 1:
                ((i.templates && i.templates.length) || (i.templates = []),
                  i.templates.push(
                    s.JitterTemplates.Template.decode(e, e.uint32()),
                  ));
                break;
              default:
                e.skipType(7 & a);
        ...
        (e.fromObject = function (e) {
          ...
          if (e.templates) {
            if (!Array.isArray(e.templates))
              throw TypeError(".JitterTemplates.templates: array expected");
            t.templates = [];
            for (var n = 0; n < e.templates.length; ++n) {
              if ("object" != typeof e.templates[n])
                throw TypeError(".JitterTemplates.templates: object expected");
              t.templates[n] = s.JitterTemplates.Template.fromObject(
                e.templates[n],
              );
            }
          }
        ...
        (e.toObject = function (e, t) {
          ...
          var n = {};
          if (
            ((t.arrays || t.defaults) && (n.templates = []),
            e.templates && e.templates.length)
          ) {
            n.templates = [];
            for (var i = 0; i < e.templates.length; ++i)
              n.templates[i] = s.JitterTemplates.Template.toObject(
                e.templates[i],
                t,
              );
          }
        ...
        (e.Template = (function () {
          ...
          return (
            ...
            (e.encode = function (e, t) {
              if (
                (t || (t = a.create()), null != e.values && e.values.length)
              ) {
                t.uint32(10).fork();
            ...
            (e.decode = function (e, t) {
              ...
              for (
                var n = void 0 === t ? e.len : e.pos + t,
                  i = new s.JitterTemplates.Template();
                e.pos < n;
              ) {
                var a = e.uint32();
                switch (a >>> 3) {
                  case 1:
                    if (
                      ((i.values && i.values.length) || (i.values = []),
                      2 == (7 & a))
                    )
                      for (var r = e.uint32() + e.pos; e.pos < r; )
                        i.values.push(e.float());
            ...
            (e.fromObject = function (e) {
              ...
              if (e.values) {
                if (!Array.isArray(e.values))
                  throw TypeError(
                    ".JitterTemplates.Template.values: array expected",
                  );
                t.values = [];
                for (var n = 0; n < e.values.length; ++n)
                  t.values[n] = Number(e.values[n]);
              }
              return t;
            }),
            (e.toObject = function (e, t) {
              ...
              var n = {};
              if (
                ((t.arrays || t.defaults) && (n.values = []),
                e.values && e.values.length)
              ) {
                n.values = [];
                for (var i = 0; i < e.values.length; ++i)
                  n.values[i] =
                    t.json && !isFinite(e.values[i])
                      ? String(e.values[i])
                      : e.values[i];
              }
              return n;
    ...
    var i = n(0),
      ...
      a = (function () {
        function e(e) {
          this.templates = [];
          for (
            var t = 0, n = o.JitterTemplates.decode(e).templates;
            t < n.length;
            t++
          ) {
            var i = n[t];
      ...
      u = (function () {
        function e(e, t, n, o, s, u, c) {
          ((this.onFrameUsed = null),
            ...
            this.setSpectralFrameData(
              this.spectralFramePointers.next(),
              Object(i.f)(258, 0),
              !0,
            ),
            this.setExcitationFrameData(
              this.excitationFramePointers.next(),
              Object(i.f)(4, -120),
              !0,
              !1,
            ));
          ...
          this.spectralGain = Object(r.b)(
            c.singers[this.singerIndex].spectralFilters,
          );
        }
        return (
          ...
          (e.prototype.setExcitationFrameData = function (e, t, n, o) {
            if ((this.module._excitationFrameReset(e, n ? 1 : 0), !n)) {
              ...
              for (var l = 0; l < 4; ++l)
                r[1 + l] =
                  s.a.aperiodicMin +
                  (0.5 * t[l] + 0.5) * (s.a.aperiodicMax - s.a.aperiodicMin);
              var u = o
                ? this.audioParameters.singers[this.singerIndex].aperiodicGain
                    .consonant
                : this.audioParameters.singers[this.singerIndex].aperiodicGain
                    .vowel;
              for (l = 0; l < 6; ++l)
                ((r[l] += u[l]), (r[l] = Math.pow(10, r[l] / 10)));
              ...
              for (l = 0; l < 4; ++l)
                h[1 + l] =
                  ...
                  (0.5 * t[l] + 0.5) * (s.a.aperiodicMax - s.a.aperiodicMin);
              for (l = 0; l < 6; ++l)
                ((h[l] = Math.pow(10, h[l] / 10)), (h[l] = 1 - h[l]));
              var d = o
                ? this.audioParameters.singers[this.singerIndex].periodicGain
                    .consonant
                : this.audioParameters.singers[this.singerIndex].periodicGain
                    .vowel;
              for (l = 0; l < 6; ++l) {
          ...
          (e.prototype.setAudioParameters = function (e) {
            ((this.audioParameters = e),
              (this.spectralGain = Object(r.b)(
                e.singers[this.singerIndex].spectralFilters,
              )));
          }),
          (e.prototype.step = function (e) {
            for (
              var t = 0;
              1 !==
                this.module._synthHasEnoughExcitationFrames(
                  this.synthPointer,
                  e,
                  this.voiceIndex,
                ) ||
              1 !==
                this.module._synthHasEnoughSpectralFrames(
                  this.synthPointer,
                  e,
                  this.voiceIndex,
                );
              ...
              for (var a = 0; a < this.lastSubsteps; ++a) {
                ...
                for (o = this.overrideF0s.length - 1; o >= 0; --o)
                  if (t > this.overrideF0s[o].delay) {
                    ((r = this.overrideF0s[o].f0),
                      (this.lastOverrideFrequency = r),
                      (l = !0));
                    break;
                  }
                if (
                  ...
                  var c =
                      ...
                      this.jitter.next() *
                        u *
                        this.audioParameters.singers[this.singerIndex]
                          .jitterScale,
                  ...
                  (this.setExcitationFrameData(
                    ...
                    this.module._voiceAddExcitationFrame(
                      this.voicePointer,
                      c,
                      h,
                    ),
    ...
    var d = (function () {
      function e(e, t, n, o, a, r, s, l, d) {
        ...
        ((this.onFrameUsed = null),
          ...
          (this.bufferSize = d));
        for (
          var m = this.module._malloc(n.length),
            f = this.module.HEAPU8.subarray(m, m + n.length),
            g = 0;
          g < n.length;
          ++g
        )
        ...
        var b,
          ...
          y = v,
          x =
            ((b = (l.targetFFTSize * this.processingSampleRate) / 32e3),
            2 * Math.ceil(b / 2));
        this.synthPointer = this.module._createSynth(
          this.processingSampleRate,
          s,
          v,
          y,
          x,
        ...
        for (g = 0; g < e; ++g)
          this.voices.push(
            new u(t, this.synthPointer, g, g, o, this.processingSampleRate, l),
          );
        ...
        this.reverbContext = t._createDCReverbContext(
          this.processingSampleRate,
        );
        var w = t.cwrap("heavySendMessage", null, [
          "number",
          "string",
          "number",
          "number",
        ...
        (w(this.reverbContext, "init", 1, 0),
          this.module._synthSetOnlyNoise(
            this.synthPointer,
            l.noiseExcitation ? 1 : 0,
          ),
      ...
      return (
        ...
        (e.prototype.process = function (e, t) {
          ...
          for (
            var l = this.outputBuffer.getArray(),
              u = this.sampleRate / this.processingSampleRate,
              c = 0;
            c < 2;
            ++c
          ) {
        ...
        (e.prototype.addOverrideF0 = function (e, t) {
          this.voices[e].addOverrideF0(
            t,
            (Date.now() - this.lastAudioProcessTime) / 1e3,
          );
        }),
        (e.prototype.benchmarkSpectrumGeneration = function (e) {
          var t = performance.now();
          this.voices[0].module._synthBenchmarkSpectrumGeneration(
            this.voices[0].synthPointer,
            e,
          );
        ...
        (e.prototype.setAudioParameters = function (e) {
          var t = this.module.cwrap("heavySendMessage", null, [
            "number",
            "string",
            "number",
            "number",
          ...
          for (var i = 0; i < this.voices.length; ++i)
            this.voices[i].setAudioParameters(e);
          this.module._synthSetOnlyNoise(
            this.synthPointer,
            e.noiseExcitation ? 1 : 0,
          );
        }),
        e
      );
  ...
  function (e, t, n) {
    ...
    i.encode = function (e, t, n) {
      for (var i, a = null, r = [], s = 0, l = 0; t < n; ) {
        ...
        s > 8191 &&
          ((a || (a = [])).push(String.fromCharCode.apply(String, r)), (s = 0));
      }
      return (
        l && ((r[s++] = o[i]), (r[s++] = 61), 1 === l && (r[s++] = 61)),
        a
          ? (s && a.push(String.fromCharCode.apply(String, r.slice(0, s))),
            a.join(""))
        ...
        "undefined" != typeof Float64Array
          ...
          : (function () {
              function t(e, t, n, i, o, a) {
                var r = i < 0 ? 1 : 0;
                if ((r && (i = -i), 0 === i))
                  (e(0, o, a + t), e(1 / i > 0 ? 0 : 2147483648, o, a + n));
                  ...
                  if (i < 22250738585072014e-324)
                    ...
                    (1024 === l && (l = 1023),
                      e(
                        (4503599627370496 * (s = i * Math.pow(2, -l))) >>> 0,
                        o,
                        a + t,
                      ),
                      e(
        ...
        for (var i, o = null, a = [], r = 0; t < n; )
          ((i = e[t++]) < 128
            ...
            r > 8191 &&
              ...
              (r = 0)));
        return o
          ? (r && o.push(String.fromCharCode.apply(String, a.slice(0, r))),
            o.join(""))
              ...
              function (e, n) {
                ...
                if (null !== n) {
                  if (!(n instanceof o))
                    try {
                      n =
                        o[s.responseDelimited ? "decodeDelimited" : "decode"](
                          n,
                        );
                    } catch (e) {
  ...
  function (e, t, n) {
    ...
    ((s.RecordedLibrettos = (function () {
      ...
      return (
        ...
        (e.encode = function (e, t) {
          if (
            (t || (t = a.create()), null != e.librettos && e.librettos.length)
          )
            for (var n = 0; n < e.librettos.length; ++n)
              s.RecordedLibrettos.RecordedLibretto.encode(
                e.librettos[n],
                t.uint32(10).fork(),
              ).ldelim();
          return t;
            ...
            switch (a >>> 3) {
              case 1:
                ((i.librettos && i.librettos.length) || (i.librettos = []),
                  i.librettos.push(
                    s.RecordedLibrettos.RecordedLibretto.decode(e, e.uint32()),
                  ));
                break;
              default:
                e.skipType(7 & a);
        ...
        (e.verify = function (e) {
          ...
          if (null != e.librettos && e.hasOwnProperty("librettos")) {
            ...
            for (var t = 0; t < e.librettos.length; ++t) {
              var n = s.RecordedLibrettos.RecordedLibretto.verify(
                e.librettos[t],
              );
          ...
          if (e.librettos) {
            ...
            for (var n = 0; n < e.librettos.length; ++n) {
              if ("object" != typeof e.librettos[n])
                throw TypeError(
                  ".RecordedLibrettos.librettos: object expected",
                );
              t.librettos[n] = s.RecordedLibrettos.RecordedLibretto.fromObject(
                e.librettos[n],
              );
            }
          }
        ...
        (e.toObject = function (e, t) {
          ...
          var n = {};
          if (
            ((t.arrays || t.defaults) && (n.librettos = []),
            e.librettos && e.librettos.length)
          ) {
            n.librettos = [];
            for (var i = 0; i < e.librettos.length; ++i)
              n.librettos[i] = s.RecordedLibrettos.RecordedLibretto.toObject(
                e.librettos[i],
                t,
              );
          }
        ...
        (e.Note = (function () {
          ...
          return (
            ...
            (e.decode = function (e, t) {
              ...
              for (
                var n = void 0 === t ? e.len : e.pos + t,
                  i = new s.RecordedLibrettos.Note();
                e.pos < n;
              ) {
                var a = e.uint32();
                switch (a >>> 3) {
              ...
              if (!i.hasOwnProperty("name"))
                throw r.ProtocolError("missing required 'name'", {
                  instance: i,
                });
              if (!i.hasOwnProperty("startTimeSeconds"))
                throw r.ProtocolError("missing required 'startTimeSeconds'", {
                  instance: i,
                });
              if (!i.hasOwnProperty("endTimeSeconds"))
                throw r.ProtocolError("missing required 'endTimeSeconds'", {
                  instance: i,
                });
              return i;
            }),
            ...
            (e.fromObject = function (e) {
              ...
              return (
                null != e.startTimeSeconds &&
                  (t.startTimeSeconds = Number(e.startTimeSeconds)),
                null != e.endTimeSeconds &&
                  (t.endTimeSeconds = Number(e.endTimeSeconds)),
                t
              );
            }),
            (e.toObject = function (e, t) {
              ...
              return (
                ...
                null != e.name &&
                  ...
                  (n.name =
                    t.enums === String
                      ? s.RecordedLibrettos.Phoneme[e.name]
                      : e.name),
                null != e.startTimeSeconds &&
            ...
            (e.encode = function (e, t) {
              if ((t || (t = a.create()), null != e.notes && e.notes.length))
                for (var n = 0; n < e.notes.length; ++n)
                  s.RecordedLibrettos.Note.encode(
                    e.notes[n],
                    t.uint32(10).fork(),
                  ).ldelim();
              return t;
                ...
                switch (a >>> 3) {
                  case 1:
                    ((i.notes && i.notes.length) || (i.notes = []),
                      i.notes.push(
                        s.RecordedLibrettos.Note.decode(e, e.uint32()),
                      ));
                    break;
                  default:
                    e.skipType(7 & a);
            ...
            (e.fromObject = function (e) {
              ...
              if (e.notes) {
                if (!Array.isArray(e.notes))
                  throw TypeError(
                    ".RecordedLibrettos.RecordedLibretto.notes: array expected",
                  );
                t.notes = [];
                for (var n = 0; n < e.notes.length; ++n) {
                  if ("object" != typeof e.notes[n])
                    throw TypeError(
                      ".RecordedLibrettos.RecordedLibretto.notes: object expected",
                    );
    ...
    ((s.RecordingMessage = (function () {
      ...
      return (
        ...
        (e.encode = function (e, t) {
          if (
            (t || (t = a.create()),
            t.uint32(8).int32(e.theme),
            null != e.parts && e.parts.length)
          )
            for (var n = 0; n < e.parts.length; ++n)
              s.RecordingMessage.Part.encode(
                e.parts[n],
                t.uint32(18).fork(),
              ).ldelim();
          return (
        ...
        (e.decode = function (e, t) {
          ...
          if (!i.hasOwnProperty("theme"))
            throw r.ProtocolError("missing required 'theme'", { instance: i });
          return i;
        }),
        (e.decodeDelimited = function (e) {
          return (e instanceof o || (e = new o(e)), this.decode(e, e.uint32()));
        ...
        (e.fromObject = function (e) {
          ...
          if (e.parts) {
            if (!Array.isArray(e.parts))
              throw TypeError(".RecordingMessage.parts: array expected");
            t.parts = [];
            for (var n = 0; n < e.parts.length; ++n) {
        ...
        (e.toObject = function (e, t) {
          ...
          if (
            ...
            null != e.theme &&
              ...
              (n.theme =
                t.enums === String
                  ? s.RecordingMessage.Theme[e.theme]
                  : e.theme),
          ...
          return (
            null != e.location &&
              ...
              (n.location =
                t.enums === String
                  ? s.RecordingMessage.Location[e.location]
                  : e.location),
            n
          );
        }),
          ...
          return (
            ...
            (e.decode = function (e, t) {
              ...
              if (!i.hasOwnProperty("duration"))
                throw r.ProtocolError("missing required 'duration'", {
                  instance: i,
                });
              return i;
            }),
            ...
            (e.verify = function (e) {
              ...
              return "number" != typeof e.duration
            ...
            (e.toObject = function (e, t) {
              ...
              return (
                t.defaults &&
                  ((n.name = t.enums === String ? "i" : 0), (n.duration = 0)),
                null != e.name &&
                  e.hasOwnProperty("name") &&
                  (n.name =
                    t.enums === String
                      ? s.RecordingMessage.Phoneme[e.name]
                      : e.name),
                null != e.duration &&
                  e.hasOwnProperty("duration") &&
                  (n.duration =
                    t.json && !isFinite(e.duration)
                      ? String(e.duration)
                      : e.duration),
                n
              );
        ...
        (e.LibrettoChunk = (function () {
          ...
          return (
            ...
            (e.decode = function (e, t) {
              ...
              for (
                var n = void 0 === t ? e.len : e.pos + t,
                  i = new s.RecordingMessage.LibrettoChunk();
                e.pos < n;
              ) {
                var a = e.uint32();
                switch (a >>> 3) {
                  case 1:
                    i.vowel = s.RecordingMessage.PhonemeWithDuration.decode(
                      e,
                      e.uint32(),
                    );
                    break;
                  case 2:
                    ((i.suffix && i.suffix.length) || (i.suffix = []),
                      i.suffix.push(
                        s.RecordingMessage.PhonemeWithDuration.decode(
                          e,
                          e.uint32(),
                        ),
                      ));
              ...
              if (!i.hasOwnProperty("vowel"))
                throw r.ProtocolError("missing required 'vowel'", {
                  instance: i,
                });
              return i;
            }),
            ...
            (e.verify = function (e) {
              if ("object" != typeof e || null === e) return "object expected";
              if ((n = s.RecordingMessage.PhonemeWithDuration.verify(e.vowel)))
                return "vowel." + n;
              if (null != e.suffix && e.hasOwnProperty("suffix")) {
                ...
                for (var t = 0; t < e.suffix.length; ++t) {
                  var n;
                  if (
                    (n = s.RecordingMessage.PhonemeWithDuration.verify(
                      e.suffix[t],
                    ))
                  )
                    return "suffix." + n;
            ...
            (e.fromObject = function (e) {
              ...
              if (null != e.vowel) {
                if ("object" != typeof e.vowel)
                  throw TypeError(
                    ".RecordingMessage.LibrettoChunk.vowel: object expected",
                  );
                t.vowel = s.RecordingMessage.PhonemeWithDuration.fromObject(
                  e.vowel,
                );
              }
              if (e.suffix) {
                if (!Array.isArray(e.suffix))
                  throw TypeError(
                    ".RecordingMessage.LibrettoChunk.suffix: array expected",
                  );
                t.suffix = [];
                for (var n = 0; n < e.suffix.length; ++n) {
                  if ("object" != typeof e.suffix[n])
                    throw TypeError(
                      ".RecordingMessage.LibrettoChunk.suffix: object expected",
                    );
                  t.suffix[n] =
                    s.RecordingMessage.PhonemeWithDuration.fromObject(
                      e.suffix[n],
                    );
                }
              }
            ...
            (e.toObject = function (e, t) {
              ...
              if (
                ...
                null != e.vowel &&
                  ...
                  (n.vowel = s.RecordingMessage.PhonemeWithDuration.toObject(
                    e.vowel,
                    t,
                  )),
                ...
                for (var i = 0; i < e.suffix.length; ++i)
                  n.suffix[i] = s.RecordingMessage.PhonemeWithDuration.toObject(
                    e.suffix[i],
                    t,
                  );
              }
          ...
          return (
            ...
            (e.encode = function (e, t) {
              return (
                ...
                s.RecordingMessage.LibrettoChunk.encode(
                  e.librettoChunk,
                  t.uint32(26).fork(),
                ).ldelim(),
                null != e.controlled &&
            ...
            (e.decode = function (e, t) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 2:
                    ...
                    break;
                  case 3:
                    i.librettoChunk = s.RecordingMessage.LibrettoChunk.decode(
                      e,
                      e.uint32(),
                    );
                    break;
              ...
              if (!i.hasOwnProperty("timeSeconds"))
                throw r.ProtocolError("missing required 'timeSeconds'", {
                  instance: i,
                });
              if (!i.hasOwnProperty("midiPitch"))
                throw r.ProtocolError("missing required 'midiPitch'", {
                  instance: i,
                });
              if (!i.hasOwnProperty("librettoChunk"))
                throw r.ProtocolError("missing required 'librettoChunk'", {
                  instance: i,
                });
              return i;
            }),
            ...
            (e.verify = function (e) {
              if ("object" != typeof e || null === e) return "object expected";
              if ("number" != typeof e.timeSeconds)
                return "timeSeconds: number expected";
              if ("number" != typeof e.midiPitch)
                return "midiPitch: number expected";
            ...
            (e.fromObject = function (e) {
              ...
              if (
                (null != e.timeSeconds &&
                  (t.timeSeconds = Number(e.timeSeconds)),
                null != e.midiPitch && (t.midiPitch = Number(e.midiPitch)),
                null != e.librettoChunk)
              ) {
                if ("object" != typeof e.librettoChunk)
                  throw TypeError(
                    ".RecordingMessage.Note.librettoChunk: object expected",
                  );
                t.librettoChunk = s.RecordingMessage.LibrettoChunk.fromObject(
                  e.librettoChunk,
                );
              }
              return (
                null != e.controlled && (t.controlled = Boolean(e.controlled)),
                t
              );
            }),
            (e.toObject = function (e, t) {
              ...
              return (
                ...
                null != e.timeSeconds &&
                  ...
                  (n.timeSeconds =
                    t.json && !isFinite(e.timeSeconds)
                      ? String(e.timeSeconds)
                      : e.timeSeconds),
                null != e.midiPitch &&
                  e.hasOwnProperty("midiPitch") &&
                  (n.midiPitch =
                    t.json && !isFinite(e.midiPitch)
                      ? String(e.midiPitch)
                      : e.midiPitch),
                null != e.librettoChunk &&
                  e.hasOwnProperty("librettoChunk") &&
                  (n.librettoChunk = s.RecordingMessage.LibrettoChunk.toObject(
                    e.librettoChunk,
                    t,
                  )),
                null != e.controlled &&
                  e.hasOwnProperty("controlled") &&
                  (n.controlled = e.controlled),
                n
              );
            }),
            (e.prototype.toJSON = function () {
        ...
        (e.Part = (function () {
          ...
          return (
            ...
            (e.encode = function (e, t) {
              if ((t || (t = a.create()), null != e.notes && e.notes.length))
                for (var n = 0; n < e.notes.length; ++n)
                  s.RecordingMessage.Note.encode(
                    e.notes[n],
                    t.uint32(10).fork(),
                  ).ldelim();
              ...
              for (
                ...
                switch (a >>> 3) {
                  case 1:
                    ((i.notes && i.notes.length) || (i.notes = []),
                      i.notes.push(
                        s.RecordingMessage.Note.decode(e, e.uint32()),
                      ));
                    break;
                  case 2:
                    ((i.startSuffix && i.startSuffix.length) ||
                      (i.startSuffix = []),
                      i.startSuffix.push(
                        s.RecordingMessage.PhonemeWithDuration.decode(
                          e,
            ...
            (e.fromObject = function (e) {
              ...
              if (e.notes) {
                if (!Array.isArray(e.notes))
                  throw TypeError(
                    ".RecordingMessage.Part.notes: array expected",
                  );
                t.notes = [];
                for (var n = 0; n < e.notes.length; ++n) {
                  if ("object" != typeof e.notes[n])
                    throw TypeError(
                      ".RecordingMessage.Part.notes: object expected",
                    );
              ...
              if (e.startSuffix) {
                if (!Array.isArray(e.startSuffix))
                  throw TypeError(
                    ".RecordingMessage.Part.startSuffix: array expected",
                  );
                t.startSuffix = [];
                for (n = 0; n < e.startSuffix.length; ++n) {
                  if ("object" != typeof e.startSuffix[n])
                    throw TypeError(
                      ".RecordingMessage.Part.startSuffix: object expected",
                    );
                  t.startSuffix[n] =
                    s.RecordingMessage.PhonemeWithDuration.fromObject(
                      e.startSuffix[n],
            ...
            (e.toObject = function (e, t) {
              ...
              if (e.startSuffix && e.startSuffix.length) {
                ...
                for (i = 0; i < e.startSuffix.length; ++i)
                  n.startSuffix[i] =
                    s.RecordingMessage.PhonemeWithDuration.toObject(
                      e.startSuffix[i],
                      t,
                    );
              }
  ...
  function (e, t) {
    e.exports = [
      ...
      [
        ...
        "David Li et Google Arts & Culture présentent",
        "डेविड ली और Google Arts & Culture पेश करते हैं",
        ...
        "David Li 氏と Google Arts & Culture による提供",
        "데이비드 리와 Google 아트 앤 컬처 제공",
        "David Li 以及 Google 艺术与文化出品",
        "David Li 與 Google 藝術與文化共同出品",
        "David Li und Google Arts & Culture präsentieren",
        'Дэвид Ли и сервис "Google Искусство и культура" представляют',
        "David Li y Google Arts & Culture presentan",
        "David Li dan Google Seni & Budaya mempersembahkan",
        "David Li a Google Arts & Culture uvádějí",
        "David Li og Google Arts & Culture præsenterer",
        "David Li i Google Arts & Culture predstavljaju",
        "David Li és a Google Arts & Culture bemutatja:",
        "Deivids Lī un “Google māksla un kultūra” piedāvā",
        "David Li en Google Arts & Culture presenteren",
        "David Li i Google Arts & Culture przedstawiają",
        "David Li e Google Arts & Culture apresentam",
        "David Li și Google Arts & Culture prezintă",
        "Девід Лі та Google Arts & Culture представляють",
      ],
      [
        "splash_title",
        "Blob Opera",
      ...
      [
        ...
        "Speel vier sangstemme in stede wêreldwyd met behulp van masjienleer",
        "Haz cantar a cuatro voces por ciudades de todo el mundo con la ayuda del aprendizaje automático",
        "Faites chanter quatre voix dans des villes du monde entier grâce au machine learning (apprentissage automatique)",
        "मशीन लर्निंग की मदद से, दुनिया भर के शहरों में चार अलग-अलग आवाज़ों में इसे चलाएं",
        "Fai cantare quattro voci nelle città di tutto il mondo con l'aiuto del machine learning",
        "Toque quatro vozes em cidades do mundo todo com ajuda do aprendizado de máquina",
        "Cheza sauti nne katika miji kote ulimwenguni, kwa usaidizi wa mashine kujifunza",
        "機械学習を利用して、世界各地で 4 人の声を奏でましょう",
        "머신러닝의 도움으로 세계의 여러 도시에서 노래하는 네 개의 목소리를 들어보세요.",
        "在机器学习技术的帮助下，运用 4 种声音在全球各大城市巡回演唱歌剧",
        "在機器學習技術的幫助下，運用四種聲音演唱歌曲，並到世界各大城市巡迴演出",
        "Geben Sie mithilfe von maschinellem Lernen ein vierstimmiges Konzert in verschiedenen Metropolen",
        "Отправляйтесь в мировое турне с оперным квартетом, созданным на основе машинного обучения.",
        "Con ayuda del aprendizaje automático, reproduce las cuatro voces en distintas ciudades del mundo",
        "Mainkan empat suara di berbagai kota di seluruh dunia dengan bantuan machine learning",
        "Pusťte si s pomocí strojového učení zpěv čtyř hlasů ve městech po celém světě",
        "Afspil fire stemmer i byer rundt omkring i verden takket være maskinlæring",
        '"Svirajte" četiri glasa u gradovima diljem svijeta uz pomoć strojnog učenja',
        "Játsszon négy hangon a világ városaiban a gépi tanulás segítségével",
        "Atskaņojiet četrbalsīgu dziedāšanu pasaules lielpilsētās ar mašīnmācīšanās palīdzību.",
        "Speel 4 stemmen in steden over de hele wereld af met de hulp van machine learning",
        "Skorzystaj z pomocy systemów uczących się i odtwórz 4 głosy w miastach na całym świecie",
        "Toque quatro vozes em cidades de todo o mundo com a ajuda da aprendizagem automática",
        "Redați patru voci în orașe din toată lumea, cu ajutorul învățării automate",
        "Співайте квартетом у різних куточках світу за допомогою машинного навчання",
      ],
      [
        "splash_sound_hint",
        "Turn up your sound!",
      ...
      [
        ...
        "Asegúrate de que tu dispositivo no esté silenciado\n",
        "Vérifiez que votre appareil n'est pas en mode silencieux",
        "पक्का कर लें कि आपका डिवाइस साइलेंट मोड में न हो",
        "Assicurati che l'audio del tuo dispositivo non sia disattivato",
        "Confira se o dispositivo não está silenciado",
        "Hakikisha kuwa sauti ya kifaa chako haijazimwa",
        "デバイスがマナーモードになっていないことを確認してください",
        "기기가 무음 모드가 아닌지 확인하세요.",
        "确保您的设备没有设为静音",
        "請確認裝置未設為靜音",
        "Ihr Gerät darf nicht stummgeschaltet sein",
        "Убедитесь, что на устройстве включен звук.",
        "Asegúrate de que el dispositivo no esté en silencio",
        "Jangan bisukan audio perangkat Anda",
        "Zkontrolujte, zda zařízení není ztlumené",
        "Sørg for, at lyden ikke er slået fra på din enhed",
        "Provjerite da zvuk na uređaju nije isključen",
        "Győződjön meg róla, hogy eszköze nincs lenémítva",
        "Pārbaudiet, vai ierīces skaņa ir ieslēgta.",
        "Zorg dat het geluid op je apparaat aanstaat",
        "Upewnij się, że Twoje urządzenie nie jest wyciszone",
        "Certifique-se de que o seu dispositivo não está em silêncio",
        "Asigurați-vă că sunetul dispozitivului nu este dezactivat",
        "Перевірте, чи не вимкнено звук на пристрої",
      ],
      [
        "label_skip_tutorial",
        "Skip tutorial",
      ...
      [
        ...
        "Faites glisser les blobs vers le haut et vers le bas pour obtenir différentes hauteurs de voix",
        "अलग-अलग सुर में गाने के लिए, ब्लॉब को ऊपर और नीचे की तरफ़ खींचें और छोड़ें",
        ...
        "ブロブを上下にドラッグすると曲のピッチが変わります",
        "음정을 변경하려면 블롭을 위아래로 드래그하세요.",
        "上下拖动 blob 可更改唱歌的音高",
        "將胖胖球上下拖曳可唱出不同的音高",
        "Ziehen Sie die Blobs nach oben und unten, um die Tonhöhe zu ändern",
        "Потяните блоба вверх или вниз, чтобы он пел разные ноты.",
        ...
        "Přetažením blobů nahoru a dolů změníte výšku zpívaného tónu",
        "Træk klumperne op og ned for at synge forskellige tonehøjder",
        "Povlačite blobove prema gore ili dolje da bi pjevali različite visine glasa",
        "Húzza a blobokat fel és le különböző hangmagasságok kiénekléséhez",
        "Velciet burbuļus uz augšu un leju, lai tiktu izdziedāti dažādi toņi.",
        "Sleep de blobs omhoog en omlaag om verschillende toonhoogtes te zingen",
        "Przeciągaj bloby w górę i w dół, aby zmieniać ton śpiewu",
        "Arraste os blobs para cima e para baixo para cantar em tons diferentes",
        "Trageți bulele în sus și în jos pentru a reda diferite tonalități",
        "Перетягуйте блоби вгору та вниз, щоб вони брали ноти різної висоти",
      ],
      [
        "tutorial_vowel",
        ...
        "Arrastra los blobs hacia delante y hacia atrás para obtener diferentes vocales.",
        "Faites glisser les blobs vers l'avant et vers l'arrière pour obtenir différentes voyelles",
        "अलग-अलग स्वर में गाने के लिए, ब्लॉब को आगे और पीछे की तरफ़ खींचें और छोड़ें",
        "Trascina i blob avanti e indietro per cambiare le vocali con cui cantano",
        "Arraste os blobs para frente e para trás para cantar vogais diferentes",
        "Buruta blobu mbele na nyuma ili ziimbe vokali tofauti",
        "ブロブを左右にドラッグすると、歌の母音が変わります",
        "모음 소리를 변경하려면 블롭을 앞뒤로 드래그하세요.",
        "左右拖动 blob 可更改元音",
        "將胖胖球左右拖曳可唱出不同的母音",
        "Ziehen Sie die Blobs vor und zurück, um verschiedene Vokale zu singen",
        "Потяните блоба вправо или влево, чтобы он пел разные гласные звуки.",
        "Arrastra los blobs hacia adelante y atrás para que canten diferentes vocales",
        "Tari blob ke depan dan belakang untuk menyanyikan suara vokal yang berbeda",
        "Přetažením blobů dopředu a dozadu změníte zpívané hlásky",
        "Træk klumperne fremad og tilbage for at synge forskellige vokaler",
        "Povlačite blobove prema naprijed ili natrag da bi pjevali različite samoglasnike",
        "Húzza a blobokat előre és hátra különböző magánhangzók kiénekléséhez",
        "Velciet burbuļus uz priekšu un atpakaļ, lai tiktu izdziedāti dažādi patskaņi.",
        "Sleep de blobs naar voren en achteren om verschillende klinkers te zingen",
        "Przeciągaj bloby do przodu i do tyłu, aby zmieniać śpiewane samogłoski",
        "Arraste os blobs para a frente e para trás para cantar vogais diferentes",
        "Trageți bulele înainte și înapoi pentru a reda diferite vocale",
        "Перетягуйте блоби вперед та назад, щоб вони співали різні голосні звуки",
      ],
      [
        "tutorial_harmonization",
        "The highest voice leads the harmony",
        "Die hoogste sangstem lei die harmonie",
        "La voz más aguda dirige la armonía.",
        "La voix la plus aiguë dirige l'harmonie",
        "सबसे ऊंचे सुर में गाने वाला ब्लॉब, मुख्य गायक होगा",
        "La voce con il tono più alto conduce l'armonia",
        "A voz mais alta conduz a harmonia",
        "Sauti ya juu zaidi ndiyo itakayoongoza ulinganifu wa sauti",
        "一番高い声がハーモニーのリードになります",
        "가장 높은 음역이 화음을 주도합니다.",
        "唱出最高音的 blob 是和声的主音",
        "唱出最高音的胖胖球是和聲的主音",
        "Die höchste Stimme ist die führende Stimme",
        "Тон задает самый высокий голос.",
        "La voz más aguda lidera la armonía",
        "Suara dengan nada tertinggi akan memimpin harmoni",
        "Nejvyšší hlas udává harmonii",
        "Den højeste stemme leder harmonien",
        "Najviši je glas primarni u harmoniji",
        "A legmagasabb hangra épül az összhang",
        "Harmoniju veido augstākā balss.",
        "De hoogste stem leidt de harmonie",
        "Najwyższy głos prowadzi harmonię",
        "A voz mais alta conduz a harmonia",
        "Cea mai înaltă voce produce armonia",
        "Найвищий голос задає тон",
      ],
      [
        "tutorial_mute",
        ...
        "Tous en chœur, maintenant ! Utilisez le bouton du son pour faire taire les blobs.",
        "अब सब साथ में गा रहे हैं! ब्लॉब की आवाज़ बंद करने के लिए, 'म्यूट करें' बटन इस्तेमाल करें",
        "Ora tutti insieme! Utilizza i pulsanti di disattivazione del suono per far restare in silenzio i blob",
        "Todos juntos agora! Use os botões de desativar o som para silenciar os blobs",
        "Kwa pamoja sasa! Tumia vitufe vya kuzima sauti ili uzime sauti ya blobu",
        "やってみましょう！ブロブの声をミュートするにはミュートボタンを押します",
        "이제 모두 설정되었습니다. 음소거 버튼으로 블롭을 음소거하세요.",
        "全员到齐！使用静音按钮可将 blob 设为静音",
        "全員到齊！使用靜音按鈕可將胖胖球設為靜音",
        "Und jetzt alle! Mit den Lautsprecher-Schaltflächen können Sie die Blobs stummschalten",
        "А теперь все вместе! Нажмите на значок громкоговорителя, чтобы отключить голос отдельного блоба.",
        ...
        "Teď všechny najednou! Pomocí tlačítek ztlumení bloby umlčíte",
        "Alle sammen nu! Brug mikrofonknapperne til at slå klumpernes lyd fra",
        "A sad svi zajedno! Pomoću gumba za isključivanje zvuka možete utišati blobove",
        "Minden a helyén van. Használja a némítás gombokat a blobok elnémításához.",
        "Tagad visi kopā! Lai izslēgtu burbuļu skaņu, izmantojiet skaņas izslēgšanas pogas.",
        "En nu allemaal samen! Je kunt het geluid van de blobs uitzetten met de knop Dempen",
        "A teraz razem! Użyj przycisków wyciszenia, aby wyciszyć bloby",
        "Todos juntos agora! Utilize os botões desativar som para silenciar os blobs",
        "Acum toți împreună! Folosiți butoanele de dezactivare a sunetului pentru ca bulele să tacă",
        "Тепер усі разом! Щоб вимкнути голоси блобів, натисніть кнопку вимкнення звуку",
      ],
      [
        "tutorial_end",
        ...
        "¡Ya está! Ahora canta tu propia ópera. Pulsa el botón Grabar para compartir tu obra.",
        'Et voilà ! À présent, faites-les chanter votre propre opéra. Appuyez sur "Enregistrer" pour partager votre œuvre.',
        "बस, हो गया! अब आप अपना ऑपरा गाएं. आपने जो गाया है उसे शेयर करने के लिए, 'रिकॉर्ड करें' बटन दबाएं.",
        "Ecco fatto! Ora puoi far cantare loro la tua opera. Seleziona Registra per condividere la tua creazione.",
        "Pronto. Agora você pode ouvir sua própria ópera. Grave para compartilhar sua criação.",
        "Ni hivyo tu! Sasa imba opera yako mwenyewe. Gusa rekodi ili ushiriki utunzi wako.",
        "そうです！では自作のオペラを歌わせてみましょう。作成したものを共有するには、録音ボタンを押します。",
        "좋습니다. 이제 나만의 오페라를 만들어 보세요. 녹화 버튼을 눌러 녹화한 오페라를 공유하세요.",
        "就这些！现在开始演唱一首歌剧吧。如果想将您演唱的作品分享给其他人，可点击“录制”。",
        "就是這麼簡單！現在來唱一齣歌劇吧。如果想分享你的成果，請按下錄製按鈕。",
        "Das wars schon! Singen Sie jetzt Ihre eigene Oper. Klicken Sie auf „Aufnehmen“, um Ihr Werk anschließend zu teilen.",
        "Отлично! Теперь вы можете создать собственное произведение. Смелее включайте запись и не забудьте поделиться своим творением с друзьями.",
        "Listo. Ahora canta tu propia ópera. Presiona Grabar para compartir tu versión.",
        "Bagus! Sekarang nyanyikan opera Anda sendiri. Tekan tombol rekam untuk membagikan hasil kreasi Anda.",
        "To je celé! Nyní můžete zpívat vlastní operu. Své dílo můžete nahrát pomocí tlačítka a potom sdílet.",
        "Lige præcis! Syng nu din egen opera. Tryk på Optag for at dele det, du skaber.",
        "To je to! Sad pjevajte vlastitu operu. Pritisnite Snimi da biste podijelili svoje djelo.",
        "Ennyi az egész. Most már elénekelheti saját operáját. Kattintson a felvételre az alkotás megosztásához.",
        "Tas arī viss! Tagad dziediet savu operu! Nospiediet “Ierakstīt”, lai kopīgotu savu sacerēto skaņdarbu.",
        "Dat is alles! Nu kun je je eigen opera zingen. Druk op Opnemen om te delen wat je hebt gemaakt.",
        "I to wszystko. Teraz zaśpiewaj własną operę. Naciśnij przycisk Nagraj, aby udostępnić swoje dzieło.",
        'Já está! Agora, cante a sua própria ópera. Clique em "Gravar” para partilhar a sua criação.',
        "Asta este tot! Acum creați propria compoziție. Atingeți butonul de înregistrare pentru a distribui creația.",
        "Ось і все. Тепер проспівайте власну оперу. Щоб поділитися результатом, увімкніть запис.",
      ],
      [
      ...
      [
        ...
        "अपने ऑपरा को शेयर करें",
        "Condividi la tua creazione",
        "Compartilhar sua criação",
        "Shiriki utunzi wako",
        "作品を共有します",
        "영상 공유",
        "分享您的作品",
        ...
        "Alkotás megosztása",
        "Kopīgojiet savu skaņdarbu",
        "Deel wat je hebt gemaakt",
        "Udostępnij swoje dzieło",
        "Partilhe a sua criação",
        "Distribuiți-vă creația",
        "Поділіться своїм твором",
      ],
      [
        "prompt_share_carol",
        "Share this carol",
        ...
        "Partagez ce chant de Noël",
        "इस तराने को शेयर करें",
        "Condividi questo canto natalizio",
        "Compartilhar esta canção",
        ...
        "Поделитесь этой песней",
        "Comparte este villancico",
        "Bagikan nyanyian ini",
        "Sdílet koledu",
        "Del denne sang",
        "Podijelite ovu pjesmu",
        "Ünnepi ének megosztása",
        "Kopīgojiet šo korāli",
        "Deel dit kerstlied",
        "Udostępnij tę kolędę",
        "Partilhe esta canção",
        "Distribuiți acest colind",
        "Поділіться цією піснею",
      ],
      [
        "prompt_unmute",
        "Click to unmute",
        ...
        "Kliknutím zapnete zvuk",
        "Klik for at slå lyden til",
        "Kliknite da biste uključili zvuk",
        "Kattintson a némítás feloldásához",
        "Noklikšķiniet, lai ieslēgtu skaņu",
        "Klik om het geluid aan te zetten",
        "Kliknij, aby wyłączyć wyciszenie",
        "Clique para reativar o som",
        "Dați clic pentru a activa sunetul",
      ...
      [
        ...
        "*सोप्रानो* से गाना सुनने के लिए, उसे खींचें और छोड़ें",
        ...
        "Потяните, чтобы блоб пел *сопрано*",
        "Arrastra para cantar en *soprano*",
        "Tarik untuk menyanyikan suara *sopran*",
        "Přetažením začne zpívat *soprán*",
        "Træk for at synge *sopran*",
        "Povucite da bi pjevao *sopran*",
        "A *szoprán* hangnemben énekléshez húzza valamelyik irányba",
        "Velciet, lai dziedātu *soprāns*",
        "Sleep om *sopraan* te zingen",
        "Przeciągnij, aby śpiewać *sopranem*",
        "Arraste para cantar *soprano*",
        "Trageți pentru a reda vocea de *soprană*",
        "Потягніть, щоб блоб співав *сопрано*",
      ],
      [
        "prompt_mezzo",
        ...
        "*मेज़ो-सोप्रानो* से गाना सुनने के लिए, उसे खींचें और छोड़ें",
        "Trascina per usare la voce *mezzosoprano*",
        "Arraste para cantar *mezzo-soprano*",
        "Buruta ili uimbe *mezzo-soprano*",
        "ドラッグすると *メゾソプラノ* が歌います",
        "드래그하여 *메조소프라노* 부르기",
        "拖动可使用*女中音*的声音演唱",
        "拖曳即可用*次女高音*的聲音演唱",
        "Ziehen, um *Mezzosopran* zu singen",
        "Потяните, чтобы блоб пел *меццо-сопрано*",
        "Arrastra para cantar en *mezzosoprano*",
        "Tarik untuk menyanyikan suara *mezzosopran*",
        "Přetažením začne zpívat *mezzosoprán*",
        "Træk for at synge *mezzosopran*",
        "Povucite da bi pjevao *mezzosopran*",
        "A *mezzoszoprán* hangnemben énekléshez húzza valamelyik irányba",
        "Velciet, lai dziedātu *mecosoprāns*",
        "Sleep om *mezzosopraan* te zingen",
        "Przeciągnij, aby śpiewać *mezzosopranem*",
        "Arraste para cantar *mezzo-soprano*",
        "Trageți pentru a reda vocea de *mezzo-soprană*",
        "Потягніть, щоб блоб співав *меццо-сопрано*",
      ],
      [
        "prompt_tenor",
        "Drag to sing *tenor*",
        ...
        "Faites glisser pour entendre la voix de *ténor*",
        "*टेनर* से गाना सुनने के लिए, उसे खींचें और छोड़ें",
        ...
        "Потяните, чтобы блоб пел *тенором*",
        "Arrastra para cantar en *tenor*",
        "Tarik untuk menyanyikan suara *tenor*",
        "Přetažením začne zpívat *tenor*",
        "Træk for at synge *tenor*",
        "Povucite da bi pjevao *tenor*",
        "A *tenor* hangnemben énekléshez húzza valamelyik irányba",
        "Velciet, lai dziedātu *tenors*",
        "Sleep om *tenor* te zingen",
        "Przeciągnij, aby śpiewać *tenorem*",
        "Arraste para cantar *tenor*",
        "Trageți pentru a reda vocea de *tenor*",
        "Потягніть, щоб блоб співав *тенором*",
      ],
      [
        "prompt_bass",
        "Drag to sing *bass*",
        ...
        "*बेस* से गाना सुनने के लिए, उसे खींचें और छोड़ें",
        ...
        "Потяните, чтобы блоб пел *басом*",
        "Arrastra para cantar en *bajo*",
        "Tarik untuk menyanyikan suara *bas*",
        "Přetažením začne zpívat *bas*",
        "Træk for at synge *bas*",
        "Povucite da bi pjevao *bas*",
        "A *basszus* hangnemben énekléshez húzza valamelyik irányba",
        "Velciet, lai dziedātu *bass*",
        "Sleep om *bas* te zingen",
        "Przeciągnij, aby śpiewać *basem*",
        "Arraste para cantar *baixo*",
        "Trageți pentru a reda vocea de *bas*",
        "Потягніть, щоб блоб співав *басом*",
      ],
      [
        "prompt_pitch",
        "Pitch:",
      ...
      [
        ...
        "Pulsa para finalizar la grabación",
        "Appuyez pour terminer l'enregistrement",
        "अपनी रिकॉर्डिंग को खत्म करने के लिए दबाएं",
        "Premi per terminare la registrazione",
        "Pressione para concluir sua gravação",
        ...
        "Presiona para terminar tu grabación",
        "Tekan tombol untuk menyelesaikan rekaman Anda",
        "Stisknutím dokončete nahrávání",
        "Tryk for at afslutte din optagelse",
        "Pritisnite da biste dovršili snimanje",
        "Nyomja meg a felvétel befejezéséhez",
        "Nospiediet, lai pabeigtu ierakstīšanu",
        "Druk om te stoppen met opnemen",
        "Naciśnij, aby zakończyć nagrywanie",
        "Prima para terminar a sua gravação",
        "Apăsați pentru a termina înregistrarea",
        "Натисніть, щоб завершити запис",
      ],
      [
        "prompt_festive",
        "Let it snow!",
      ...
      [
        ...
        "Die hoogste sangstem lei die harmonie",
        "El tipo de voz más agudo dirige la armonía.",
        "Le type de voix le plus aigu dirige l'harmonie",
        "सबसे ऊंचे सुर में गाने वाला ब्लॉब मुख्य गायक होगा",
        "Il tipo di voce più alto conduce l'armonia",
        ...
        "唱出最高音的 blob 是和声的主音",
        "唱出最高音的胖胖球是和聲的主音",
        "Die höchste Stimmlage ist die führende Stimme",
        "Тон задает самый высокий голос.",
        "El tipo de voz más aguda lidera la armonía",
        "Jenis suara dengan nada tertinggi akan memimpin harmoni",
        "Nejvyšší hlas udává harmonii",
        "Den højeste stemmetype leder harmonien",
        "Najviša je vrsta glasa primarni glas u harmoniji",
        "A legmagasabb hangnemre épül az összhang",
        "Harmoniju veido augstākā balss",
        "De hoogste stem leidt de harmonie",
        "Najwyższy rodzaj głosu prowadzi harmonię",
        "O tipo de voz mais alto conduz a harmonia",
        "Cel mai înalt tip de voce produce armonia",
        "Найвищий голос задає тон",
      ],
      [
        "prompt_carols",
        ...
        "Escucha canciones navideñas",
        "Écoutez des chants de Noël !",
        "त्योहारों के कुछ गाने सुनें!",
        "Ascolta alcuni brani natalizi.",
        "Ouça músicas festivas",
        "Sikiliza baadhi ya nyimbo za msimu wa sikukuu!",
        "祝祭歌を聴いてみましょう！",
        "축제 분위기의 노래 듣기",
        "听一些节日歌曲！",
        "聽點節慶歌曲！",
        "Hören Sie sich festliche Lieder an!",
        "Послушайте праздничные песни!",
        "¡Escucha canciones navideñas!",
        "Dengarkan lagu-lagu yang penuh suka ria",
        "Poslechněte si sváteční písně!",
        "Hør nogle julesange!",
        "Poslušajte neke blagdanske pjesme!",
        "Hallgasson meg néhány ünnepi dalt!",
        "Noklausieties dažas svētku dziesmas!",
        "Luister naar feestelijke nummers",
        "Posłuchaj świątecznych utworów!",
        "Ouça músicas festivas!",
        "Ascultați câteva cântece festive!",
        "Послухайте святкові пісні!",
      ],
      [
        "prompt_location_songs",
        "Hear a local song!",
        "Hoor 'n plaaslike liedjie!",
        "Escucha una canción local",
        "Écoutez un chant local !",
        "कोई लोक गीत सुनें!",
        "Ascolta un brano locale.",
        "Ouça uma música local",
        "Sikiliza wimbo wa mahali ulipo!",
        "ご当地ソングを聴いてみましょう！",
        "민요 듣기",
        "听一首当地歌曲！",
        "聽一首當地歌曲！",
        "Hören Sie sich ein Lied aus der Region an!",
        "Послушайте традиционную музыку!",
        "¡Escucha una canción local!",
        "Dengarkan lagu lokal",
        "Poslechněte si místní píseň.",
        "Hør en lokal sang!",
        "Poslušajte lokalnu pjesmu!",
        "Hallgasson meg egy helyi dalt!",
        "Noklausieties kādu vietējo dziesmu!",
        "Luister naar een lokaal nummer",
        "Posłuchaj lokalnego utworu!",
        "Ouça uma música local!",
        "Ascultați un cântec local!",
        "Послухайте місцеві пісні!",
      ],
      [
        "info_body",
      ...
      [
        ...
        "Blob Opera toer tans! Speel vier operastemme en sien hoe hulle optree in stede wêreldwyd. Hier is een wat ek gemaak het vir <city>",
        "¡Blob Opera está de gira! Haz cantar a cuatro voces de ópera y disfruta de sus actuaciones en distintas ciudades de todo el mundo. Aquí hay una que grabé en <city> 🎼.",
        "Blob Opera en tournée ! Faites chanter quatre voix d'opéra et regardez-les se produire dans des villes du monde entier. Voici une œuvre que j'ai composée pour <city> 🎼",
        "Blob Opera टूर पर है! ऑपरा की चार अलग-अलग आवाज़ें चलाएं और कलाकारों को दुनिया भर के शहरों में परफ़ॉर्म करते देखें. मैंने <city> के लिए यह बनाया है 🎼",
        "Blob Opera è in tour! Fai cantare quattro voci liriche e guardale mentre si esibiscono nelle città di tutto il mondo. Ecco uno spettacolo che ho creato per <city>",
        "A Blob Opera está em uma turnê mundial! Toque quatro vozes de ópera e veja-as se apresentando em cidades do mundo todo. Ouça esta que eu criei para <city>",
        ...
        "Blob Opera はツアー中です。4 人のオペラ歌手の声を聴き、世界各地での歌唱を見てみましょう。これは私が <city> 向けに作成したものです。 🎼",
        "블롭 오페라와 여행을 떠나세요. 네 개의 오페라 목소리를 재생하고 전 세계 도시에서 공연하는 모습을 감상하세요. <city>을(를) 배경으로 만든 영상을 확인해 보세요. 🎼",
        "Blob Opera 正在巡回演出！在世界各地的城市以 4 种歌剧声音演出，并观看它们的表演。下面是我为<city>创作的歌曲 🎼",
        "Blob Opera 現正巡迴中！運用四種歌劇人聲，在世界各大城市巡迴表演。這是我為<城市名稱>創作的歌曲",
        "Blob Opera ist auf Tour! Lasse vier Opernstimmen singen und in verschiedenen Metropolen der Welt auftreten. Hier ist eine Komposition, die ich für <city> gemacht habe 🎼",
        "Blob Opera отправляется в турне. Гастролируйте с оперным квартетом по всему миру. <city>, эта песня для тебя! 🎼",
        "¡Blob Opera está de gira! Reproduce cuatro voces de ópera y míralas actuar en ciudades de todo el mundo. Aquí hay uno que hice para <city> 🎼",
        ...
        "Blob Opera jede na turné! Přehrávejte zpěv čtyř operních hlasů a sledujte jejich vystoupení v městech po celém světě. Tohle je můj výtvor z města <city> 🎼",
        "Blob Opera er på turné! Afspil fire operastemmer, og se dem optræde i byer rundt omkring i verden. Her er en opera, jeg har lavet til <city> 🎼",
        'Blob Opera je na turneji! "Svirajte" četiri operna glasa i gledajte njihove nastupe u gradovima diljem svijeta. Evo jednog mojeg za <city> 🎼',
        "A Blob Opera turnézik! Játsszon négy operaénekes hangján, és üljön be az előadásokra a világ városaiban. Íme az egyik, amelyet <city> városához komponáltam. 🎼",
        "“Blob Opera” dziedātāji ir devušies turnejā! Atskaņojiet četras operdziedātāju balsis un skatiet uzstāšanos pasaules lielpilsētās. Šādu programmu es izveidoju pilsētai <city> 🎼",
        ...
        "Blob Opera w trasie koncertowej! Odtwórz 4 głosy operowe i obejrzyj występy w miastach na całym świecie. Tłem dla tego występu jest <city> 🎼",
        "O Blob Opera está em digressão! Toque quatro vozes de ópera e veja apresentações em várias cidades de todo o mundo. Ouça esta que eu que fiz para <city> 🎼",
        "Opera cu bule pleacă în turneu! Redați patru voci de operă și ascultați-le în orașe din întreaga lume. Iată o melodie compusă pentru <city> 🎼",
        "Blob Opera вирушає в турне! Співайте оперним квартетом у різних містах по всьому світі. Ось приклад пісні. Це <city>! 🎼",
      ],
      [
        ...
        "¡Blob Opera está de gira! Oye cómo cantan <song> en <city> y luego crea tu propia obra 🎼.",
        'Blob Opera en tournée ! Écoutez-les chanter "<song>" dans la ville de <city>, puis créez votre propre composition 🎼',
        "Blob Opera टूर पर है! <city> में उन्हें <song> गाते हुए सुनें. इसके बाद, अपनी धुन बनाएं 🎼",
        "Blob Opera è in tour! Ascolta i blob cantare <song> a <city> e poi crea la tua composizione",
        "A Blob Opera está em uma turnê mundial! Ouça uma apresentação da música <song> em <city> e crie sua própria composição",
        "Blob Opera iko katika ziara! Zisikilize zikiimba <song> mjini <city> kisha utunge wimbo wako mwenyewe 🎼",
        "Blob Opera はツアー中です。<city> で <song> を歌う 4 人の歌声を聴いて、今度は自分で作曲してみましょう。 🎼",
        "블롭 오페라와 여행을 떠나세요. <city>에서 부르는 <song>을(를) 감상하고 직접 작곡해 보세요. 🎼",
        "Blob Opera 正在巡回演出！听听它们在<city>演唱的<song>，并创作自己的作品 🎼",
        "Blob Opera 現正巡迴中！聆聽胖胖球在<city>演唱〈<song>〉，並自行創作歌曲",
        "Blob Opera ist auf Tour! Hör dir an, wie die Blobs das Lied <song> in <city> singen, und komponiere dann ein eigenes Stück 🎼",
        'Blob Opera отправляется в турне. Это <city>! Послушайте, как блобы исполнят композицию "<song>", и сочините собственный шедевр. 🎼',
        "¡Blob Opera está de gira! Escúchalos cantar <song> en <city> y, luego, crea tu propia composición 🎼",
        "Blob Opera sedang melakukan tur! Nikmati lagu <song> yang mereka bawakan di <city>, lalu ciptakan komposisi Anda sendiri. 🎼",
        "Blob Opera jede na turné! Poslechněte si píseň <song> ve městě <city> a pak vytvořte vlastní skladbu 🎼",
        "Blob Opera er på turné! Hør dem synge <song> i <city>, og skab derefter din egen komposition 🎼",
        "Blob Opera je na turneji! Poslušajte kako pjevaju pjesmu <song> u gradu <city>, a zatim skladajte vlastitu skladbu 🎼",
        "A Blob Opera turnézik! Hallgassa meg, ahogy a(z) <song> dalt éneklik <city> városában, majd szerezzen saját zenét. 🎼",
        "“Blob Opera” dziedātāji ir devušies turnejā! Klausieties dziesmu <song> pilsētā <city>, pēc tam saceriet savu skaņdarbu 🎼",
        "Blob Opera gaat op tournee. Hoor ze <song> zingen in <city> en maak dan je eigen compositie 🎼",
        "Blob Opera w trasie koncertowej! Posłuchaj, jak <city> wypełnia się brzmieniem utworu <song>, a potem stwórz własną kompozycję 🎼",
        "O Blob Opera está em digressão! Ouça essas vozes a cantarem <song> em <city>. Em seguida, crie a sua própria composição 🎼",
        "Opera cu bule pleacă în turneu! Ascultați bulele care cântă <song> în <city>, apoi creați propria compoziție 🎼",
        "Blob Opera вирушає в турне! Це <city>! Послухайте, як блоби виконують пісню <song>, а потім створіть власну композицію 🎼",
      ],
      [
        ...
        "Amplía la altura de tu ventana para ver este experimento",
        "Agrandissez votre fenêtre pour voir cette expérience",
        "इस प्रयोग को देखने के लिए, अपनी विंडो को बड़ा करें",
        ...
        "この実験を表示するには、ウィンドウの高さを広げてください",
        "실험을 보려면 창 높이를 높이세요.",
        "须增加窗口高度才能查看此实验项目",
        "必須增加視窗高度才能查看這項實驗",
        "Maximieren Sie die Höhe des Fensters, damit Sie das Experiment vollständig sehen können",
        "Чтобы увидеть эксперимент, увеличьте высоту окна.",
        "Expande la altura de la ventana para ver este experimento",
        "Luaskan tinggi jendela untuk melihat eksperimen ini",
        "Chcete-li tento experiment zobrazit, zvětšete výšku okna",
        "Gør vinduet højere for at se dette eksperiment",
        "Povećajte prozor u visinu da biste vidjeli ovaj eksperiment",
        "A kísérlet megtekintéséhez növelje az ablak magasságát",
        "Lai skatītu šo eksperimentu, izvērsiet loga augstumu.",
        "Maak je venster hoger om dit experiment te bekijken",
        "Powiększ okno, aby wyświetlić ten eksperyment",
        "Expanda a altura da janela para ver esta experiência",
        "Extindeți înălțimea ferestrei pentru a viziona acest experiment",
        "Щоб переглядати цей експеримент, збільште висоту вікна",
      ],
      [
        ...
        "Pour bien visualiser cette expérience, passez en mode portrait",
        "यह प्रयोग पोर्ट्रेट मोड में सबसे बढ़िया दिखता है",
        "Questo esperimento si vede in modo ottimale in modalità Ritratto",
        "Este experimento pode ser visualizado melhor em Modo retrato",
        "Jaribio hili hutazamwa vyema zaidi katika mkao wima",
        "この実験は縦向きで表示することをおすすめします",
        "실험은 세로 모드에서 가장 잘 표시됩니다.",
        "为获得最佳体验，请以纵向模式浏览此实验项目",
        "為獲得最佳體驗，請以直向模式查看這項實驗",
        "Am besten lässt sich das Experiment im Hochformat betrachten",
        "Рекомендуем открывать экспериментальный проект в вертикальном расположении.",
        "Este experimento se ve mejor en modo vertical",
        "Eksperimen ini paling optimal dilihat dalam mode potret",
        "Tento experiment je nejlepší zobrazit na výšku",
        "Eksperimentet fungerer bedst i portrættilstand",
        "Ovaj eksperiment najbolje je gledati u portretnom načinu",
        "A legjobb élmény érdekében portré módban tekintse meg a kísérletet",
        "Šo eksperimentu ieteicams skatīt portreta režīmā.",
        "Je kunt dit experiment het best bekijken in de portretmodus",
        "Ten eksperyment najlepiej jest wyświetlać w orientacji pionowej",
        "Conseguirá visualizar melhor esta experiência no modo vertical.",
        "Experimentul poate fi vizionat cel mai bine în modul portret",
        "Цей експеримент найкраще переглядати в портретній орієнтації",
      ],
      [
        "performance_warning",
        ...
        "Puede que no estés disfrutando de una experiencia óptima. Prueba con un ordenador.",
        "Nous avons constaté que vous ne profitiez peut-être pas d'une expérience optimale. Pourquoi ne pas essayer avec un ordinateur ?",
        "हमें लगता है कि आपको सबसे बढ़िया अनुभव नहीं मिल पा रहा है. क्यों न इसे डेस्कटॉप डिवाइस पर चलाएं!",
        "Abbiamo rilevato che la tua esperienza potrebbe non essere ottimale. Prova a usare un dispositivo desktop.",
        "Detectamos que sua experiência pode não ser a ideal. Tente usar um dispositivo desktop.",
        "Tumegundua kuwa huenda hupati hali bora ya utumiaji. Kwa nini usiijaribu kwenye kompyuta ya aina yoyote!",
        "最適な環境でご利用いただけていない可能性があります。デスクトップ デバイスでお試しください。",
        "현재 환경이 최적화되지 않은 것으로 보입니다. 데스크톱 기기에서 시도해 보세요.",
        "系统检测到您可能没有获得最佳体验。不妨在桌面设备上试试！",
        "系統發現目前的裝置可能無法提供最佳體驗，建議你在電腦上試試看！",
        "Wir haben festgestellt, dass das Experiment auf Ihrem Gerät womöglich nicht optimal funktioniert. Probieren Sie es doch einmal auf einem Desktop-Gerät aus!",
        "Мы заметили, что у вас что-то работает неправильно. Попробуйте открыть эксперимент на компьютере.",
        "Detectamos que es posible que no tengas una experiencia óptima. Prueba en un dispositivo de escritorio.",
        ...
        "Zjistili jsme, že vám experiment možná nefunguje správně. Zkuste ho spustit na počítači.",
        "Vi har registreret, at din oplevelse muligvis ikke er optimal. Prøv eksperimentet på en computer i stedet!",
        "Otkrili smo da možda nemate optimalan doživljaj. Mogli biste pokušati na računalu!",
        "Észrevettük, hogy nem optimális a felhasználói élmény. Próbálja meg asztali eszközön.",
        "Esam konstatējuši, ka jūs, iespējams, negūstat optimālu pieredzi. Izmēģiniet šo eksperimentu datorā!",
        "We merken dat het niet optimaal voor je werkt. Probeer het eens op een desktop.",
        "Wykryliśmy nieoptymalną jakość. Spróbuj na komputerze!",
        "Detetámos que pode não estar a ter uma experiência ideal. Tente abri-lo num computador!",
        "Am detectat că este posibil să nu beneficiați de o experiență optimă. Încercați pe un computer!",
        "Ми виявили, що щось не так. Може, спробуєте на комп’ютері?",
      ],
      [
        ...
        "मौजूदा डिवाइस के साथ जारी रखें",
        ...
        "继续使用当前设备",
        "繼續使用目前的裝置",
        "Mit aktuellem Gerät fortfahren",
        "Продолжить на этом устройстве",
        "Continúa con el dispositivo actual",
        "Lanjutkan dengan perangkat saat ini",
        "Pokračovat v aktuálním zařízení",
        "Fortsæt med den aktuelle enhed",
        "Nastavite na trenutačnom uređaju",
        "Folytatás a jelenlegi eszközön",
        "Turpināt pašreizējā ierīcē",
        "Doorgaan met het huidige apparaat",
        "Kontynuuj na bieżącym urządzeniu",
        "Continuar com o dispositivo atual",
        "Continuați pe dispozitivul actual",
        "Продовжити на поточному пристрої",
      ],
      [
        "disclaimer_ios",
        ...
        "Este experimento utiliza la tecnología de audio web más reciente. Es posible que no funcione de forma óptima en el iPhone 6 y en dispositivos más antiguos.",
        "Cette expérience utilise la technologie audio Web la plus récente. Il est possible que les performances ne soient pas optimales sur un iPhone 6 et des appareils plus anciens",
        "यह एक ऐसा प्रयोग है जिसमें नई वेब ऑडियो टेक्नोलॉजी का इस्तेमाल किया गया है. हो सकता है कि यह iPhone 6 और उससे पुराने डिवाइसों पर सही तरीके से काम न करे",
        "Questo è un esperimento che utilizza la tecnologia audio sul Web di ultima generazione. Potrebbe non funzionare in modo ottimale su iPhone 6 e dispositivi meno recenti",
        "Este experimento usa tecnologias recentes de áudio da Web. Talvez ele não funcione de maneira ideal no iPhone 6 e em dispositivos mais antigos",
        ...
        "これは、最新のウェブ オーディオ テクノロジーを使用した実験です。iPhone 6 以前のデバイスでは最適なパフォーマンスが得られない可能性があります",
        "이 실험은 최신 웹 오디오 기술을 사용합니다. iPhone 6 이전 기기에서 잘 작동하지 않을 수 있습니다.",
        "此实验项目采用最新网络音频技术，在 iPhone 6 及更旧的设备上可能无法以最佳方式呈现",
        "這項實驗採用了最新的網路音訊技術，iPhone 6 和舊款裝置可能無法以最佳方式呈現",
        "Dieses Experiment basiert auf der neuesten Web-Audiotechnologie. Auf dem iPhone 6 und älteren Geräten funktioniert es möglicherweise nicht optimal.",
        "Этот экспериментальный проект основан на новейшей аудиотехнологии, поэтому может работать некорректно на iPhone 6 и более ранних моделях.",
        "Este experimento usa lo último en tecnología de audio web. Es posible que no funcione correctamente en iPhone 6 ni dispositivos más antiguos.",
        ...
        "Tento experiment využívá nejnovější technologie zpracování webového zvuku. Na iPhonu 6 a starších zařízeních nemusí fungovat správně",
        "Dette er et eksperiment, der anvender den nyeste weblydsteknologi. Det fungerer muligvis ikke optimalt på iPhone 6 og ældre enheder",
        "Ovo je eksperiment u kojem se koristi najnovija audiotehnologija za web. Možda neće optimalno funkcionirati na iPhoneu 6 i starijim uređajima",
        "Ez egy kísérlet, amely a legfejlettebb internetes audiotechnológiát használja. Előfordulhat, hogy az iPhone 6 vagy annál régebbi eszközökön nem optimális a felhasználói élmény.",
        "Šis ir eksperiments, kurā tiek izmantota jaunākā tīmekļa audio tehnoloģija. Iespējams, tālrunī iPhone 6 un vecākās ierīcēs eksperimenta darbība nebūs optimāla.",
        ...
        "To eksperyment wykorzystujący najnowsze internetowe technologie dźwięku. Może nie działać optymalnie na iPhonie 6 i starszych urządzeniach",
        "Esta experiência utiliza a tecnologia mais recente de áudio da Web. Pode não funcionar de forma perfeita no iPhone 6 e em dispositivos mais antigos",
        "Acesta este un experiment care folosește cea mai recentă tehnologie audio pentru web. Este posibil să nu funcționeze optim pe iPhone 6 și dispozitive mai vechi",
        "Це експеримент на основі найновішої вебаудіотехнології, тому на iPhone 6 або старіших пристроях він може працювати неналежним чином",
      ],
      [
        ...
        "Blob Opera es un experimento que utiliza la tecnología de audio web más reciente y puede que no funcione de forma óptima en el iPhone 6 y en dispositivos más antiguos.",
        "Blob Opera est une expérience qui utilise la technologie audio Web la plus récente. Il est possible que les performances ne soient pas optimales sur un iPhone 6 et des appareils plus anciens.",
        "Blob Opera एक ऐसा प्रयोग है जिसमें नई वेब ऑडियो टेक्नोलॉजी का इस्तेमाल किया गया है. हो सकता है कि यह iPhone 6 और उससे पुराने डिवाइसों पर सही तरीके से काम न करे",
        "Blob Opera è un esperimento che utilizza la tecnologia audio sul Web di ultima generazione e potrebbe non funzionare in modo ottimale su iPhone 6 e dispositivi meno recenti",
        "A Blob Opera é um experimento que usa tecnologias recentes de áudio da Web e talvez não funcione de maneira ideal no iPhone 6 e em dispositivos mais antigos.",
        ...
        "Blob Opera は、最新のウェブ オーディオ テクノロジーを使用した実験であり、iPhone 6 以前のデバイスでは最適なパフォーマンスが得られない可能性があります",
        "블롭 오페라는 최신 웹 오디오 기술을 사용한 실험으로 iPhone 6 이전 기기에서는 잘 작동하지 않을 수 있습니다.",
        "Blob Opera 是一个利用最新网络音频技术的实验项目，在 iPhone 6 及更旧的设备上可能无法以最佳方式呈现",
        "Blob Opera 是採用最新網路音訊技術的實驗，iPhone 6 和舊款裝置可能無法以最佳方式呈現",
        "Blob Opera ist ein Experiment, das auf der neuesten Web-Audiotechnologie basiert, und funktioniert deshalb möglicherweise auf dem iPhone 6 und älteren Geräten nicht optimal",
        "Экспериментальный проект Blob Opera основан на новейшей аудиотехнологии, поэтому может работать некорректно на iPhone 6 и более ранних моделях.",
        "Blob Opera es un experimento que usa lo último en tecnología de audio web y es posible que no funcione correctamente en iPhone 6 y dispositivos más antiguos",
        ...
        "Blob Opera je experiment, který využívá nejnovější technologie zpracování webového zvuku a na iPhonu 6 a starších zařízeních nemusí fungovat správně",
        "Blob Opera er et eksperiment, der anvender den nyeste weblydsteknologi, hvorfor det muligvis ikke fungerer optimalt på iPhone 6 og ældre enheder",
        "Blob Opera je eksperiment u kojem se koristi najnovija audiotehnologija za web, pa možda neće optimalno funkcionirati na iPhoneu 6 i starijim uređajima",
        "A Blob Opera egy kísérlet, amely a legfejlettebb internetes audiotechnológiát használja, ezért előfordulhat, hogy az iPhone 6 vagy annál régebbi eszközökön nem nyújt optimális élményt.",
        "“Blob Opera” ir eksperiments, kurā tiek izmantota jaunākā tīmekļa audio tehnoloģija. Iespējams, tālrunī iPhone 6 un vecākās ierīcēs eksperimenta darbība nebūs optimāla.",
        ...
        "Blob Opera to eksperyment wykorzystujący najnowsze internetowe technologie dźwięku i może nie działać optymalnie na iPhonie 6 i starszych urządzeniach",
        "O Blob Opera é uma experiência que utiliza a tecnologia mais recente de áudio da Web e pode não funcionar de forma perfeita no iPhone 6 e em dispositivos mais antigos",
        "Opera cu bule este un experiment care folosește cea mai recentă tehnologie audio pentru web și poate să nu funcționeze optim pe iPhone 6 și dispozitive mai vechi",
        "Blob Opera – це експеримент на основі найновішої вебаудіотехнології, тому на iPhone 6 або старіших пристроях він може працювати неналежним чином",
      ],
      [
        "disclaimer",
        ...
        "Este experimento utiliza la tecnología de audio web más reciente. Es posible que no funcione de forma óptima en dispositivos antiguos.",
        "Cette expérience utilise la technologie audio Web la plus récente. Il est possible que les performances ne soient pas optimales sur des appareils plus anciens.",
        "यह एक ऐसा प्रयोग है जिसमें नई वेब ऑडियो टेक्नोलॉजी का इस्तेमाल किया गया है. हो सकता है कि यह पुराने डिवाइसों पर सही तरीके से काम न करे.",
        "Questo è un esperimento che utilizza la tecnologia audio sul Web di ultima generazione. Potrebbe non funzionare in modo ottimale su dispositivi meno recenti.",
        "Este experimento usa tecnologias recentes de áudio da Web. Talvez ele não funcione de maneira ideal em dispositivos mais antigos",
        ...
        "これは、最新のウェブ オーディオ テクノロジーを使用した実験です。古いデバイスでは最適なパフォーマンスが得られない可能性があります。",
        "이 실험은 최신 웹 오디오 기술을 사용합니다. 오래된 기기에서는 잘 작동하지 않을 수 있습니다.",
        "此实验项目采用最新网络音频技术，在旧款设备上可能无法以最佳方式呈现。",
        "這項實驗採用了最新的網路音訊技術，舊款裝置可能無法以最佳方式呈現。",
        "Dieses Experiment basiert auf der neuesten Web-Audiotechnologie. Auf älteren Geräten funktioniert es deshalb möglicherweise nicht optimal.",
        "Этот экспериментальный проект основан на новейшей аудиотехнологии, поэтому может работать некорректно на старых моделях устройств.",
        "Este experimento usa lo último en tecnología de audio web. Es posible que no funcione correctamente en dispositivos antiguos.",
        ...
        "Tento experiment využívá nejnovější technologie zpracování webového zvuku. Na starších zařízeních nemusí fungovat správně.",
        "Dette er et eksperiment, der anvender den nyeste weblydsteknologi. Det fungerer muligvis ikke optimalt på ældre enheder.",
        "Ovo je eksperiment u kojem se koristi najnovija audiotehnologija za web. Možda neće optimalno funkcionirati na starijim uređajima",
        "Ez egy kísérlet, amely a legfejlettebb internetes audiotechnológiát használja. Előfordulhat, hogy régebbi eszközökön nem optimális a felhasználói élmény.",
        "Šis ir eksperiments, kurā tiek izmantota jaunākā tīmekļa audio tehnoloģija. Iespējams, vecākās ierīcēs eksperimenta darbība nebūs optimāla.",
        "Dit is een experiment met de nieuwste webaudiotechnologie. Het werkt misschien niet optimaal op oudere apparaten.",
        "To eksperyment wykorzystujący najnowsze internetowe technologie dźwięku. Może nie działać optymalnie na starszych urządzeniach.",
        "Esta experiência utiliza a tecnologia mais recente de áudio da Web. Pode não funcionar de forma perfeita em dispositivos mais antigos.",
        "Acesta este un experiment care folosește cea mai recentă tehnologie audio pentru web. Poate să nu funcționeze optim pe dispozitive mai vechi.",
        "Це експеримент на основі найновішої вебаудіотехнології, тому на старіших пристроях він може працювати неналежним чином.",
      ],
      [
        "prompt_locations",
        "Take the blobs on tour!",
        "Neem die blertse op toer!",
        "¡Llévate a los blobs de gira!",
        "Partez en tournée avec les blobs !",
        "ब्लॉब को टूर पर ले जाएं!",
        "Porta i blob in tour!",
        "Leve os blobs em uma turnê mundial!",
        ...
        "Отправляйтесь с блобами в турне!",
        "¡Lleva a los blobs de gira!",
        "Ajak para blob melakukan tur",
        "Vezměte bloby na turné!",
        "Tag klumperne med på turné!",
        "Povedite blobove na turneju!",
        "Turnézzon a blobokkal!",
        "Dodieties ar burbuļiem turnejā!",
        "Ga met de blobs op tournee",
        "Zabierz bloby w trasę koncertową!",
        "Leve os blobs em digressão!",
        "Mergeți cu bulele în turneu!",
        "Вирушайте з блобами в турне!",
      ],
      [
      ...
      [
        ...
        "Tradiční irská píseň",
        "Traditionel irsk sang",
        "Tradicionalna irska pjesma",
        "Hagyományos ír dal",
        "Tradicionāla īru dziesma",
        "Traditioneel Iers nummer",
        "Tradycyjna pieśń irlandzka",
        "Canção tradicional irlandesa",
        "Cântec tradițional irlandez",
        "Традиційна ірландська пісня",
      ],
      [
      ...
      [
        ...
        "Canción escocesa tradicional",
        "Lagu tradisional Skotlandia",
        "Tradiční skotská píseň",
        "Traditionel skotsk sang",
        "Tradicionalna škotska pjesma",
        "Hagyományos skót dal",
        "Tradicionāla skotu dziesma",
        "Traditioneel Schots nummer",
        "Tradycyjna pieśń szkocka",
        "Canção tradicional escocesa",
        "Cântec tradițional scoțian",
        "Традиційна шотландська пісня",
      ],
      [
        "song_wellerman_name",
        "Wellerman",
      ...
      [
        ...
        "Традиционная матросская песня",
        "Sea shanty tradicional",
        "Yel-yel laut tradisional",
        "Tradiční námořnický popěvek",
        "Traditionel shanty",
        "Tradicionalna mornarska pjesma",
        "Hagyományos tengerésznóta",
        "Tradicionāla jūrnieku dziesma",
        "Traditioneel matrozenliedje",
        "Tradycyjna szanta",
        "Canção marítima tradicional",
        "Cântec tradițional marinăresc",
        "Традиційна матроська пісня",
      ],
      [
      ...
      [
        ...
        "Canción galesa tradicional",
        "Lagu tradisional Wales",
        "Tradiční velšská píseň",
        "Traditionel walisisk sang",
        "Tradicionalna velška pjesma",
        "Hagyományos walesi dal",
        "Tradicionāla velsiešu dziesma",
        "Traditioneel Welsh nummer",
        "Tradycyjna pieśń walijska",
        "Canção tradicional galesa",
        "Cântec tradițional galez",
        "Традиційна валлійська пісня",
      ],
      [
      ...
      [
        ...
        "Canción tradicional india",
        "Chant traditionnel hindi",
        "पारंपरिक हिन्दी गीत",
        "Brano tradizionale hindi",
        "Canção tradicional hindi",
        ...
        "Традиционная индийская песня",
        "Canción hindú tradicional",
        "Lagu tradisional Hindi",
        "Tradiční hindská píseň",
        "En traditionel hindisang",
        "Tradicionalna hindska pjesma",
        "Hagyományos hindi dal",
        "Tradicionāla hindu dziesma",
        "Een traditioneel Hindi nummer",
        "Tradycyjna pieśń w hindi",
        "Uma canção tradicional em hindi",
        "Cântec tradițional indian",
        "Традиційна індійська пісня",
      ],
      [
      ...
      [
        ...
        "Amerikai népdal",
        "Amerikāņu tautas dziesma",
        "Amerikaans volksnummer",
        "Amerykańska piosenka folkowa",
        "Canção folclórica americana",
        "Cântec folk american",
        "Американська народна пісня",
      ],
      [
        "song_frere_jacques_name",
        "Frère Jacques",
        "Frère Jacques (Vader Jakob)",
        "Frère Jacques",
        "Frère Jacques",
        "फ़्रे जाक",
        "Fra' Martino",
      ...
      [
        ...
        "Canción popular sudafricana",
        "Chanson populaire sud-africaine",
        "दक्षिण अफ़्रीकी लोक गीत",
        "Brano tradizionale sudafricano",
        "Canção folclórica sul-africana",
        "Wimbo wa kitamaduni wa Afrika Kusini",
        "南アフリカ民謡",
        "남아프리카 공화국 민요",
        "南非民谣",
        "南非民謠",
        "Südafrikanisches Volkslied",
        "Южноафриканская народная песня",
        "Canción popular de Sudáfrica",
        "Lagu rakyat Afrika Selatan",
        "Jihoafrická lidová píseň",
        "Sydafrikansk folkesang",
        "Južnoafrička narodna pjesma",
        "Dél-afrikai népdal",
        "Dienvidāfrikāņu tautas dziesma",
        "Zuid-Afrikaans volksnummer",
        "Południowoafrykańska piosenka ludowa",
        "Canção folclórica sul-africana",
        "Cântec folk sud-african",
        "Південноафриканська народна пісня",
      ],
      [
      ...
      [
        ...
        "Canción gospel norteamericana",
        "Chanson gospel américaine",
        "ईसा मसीह के उपदेशों पर आधारित अमेरिकन गीत",
        "Brano gospel statunitense",
        "Canção gospel americana",
        ...
        "Американская песня в жанре госпел",
        "Canción góspel estadounidense",
        "Lagu gospel Amerika",
        "Americký gospel",
        "Amerikansk gospelsang",
        "Američka gospel pjesma",
        "Amerikai gospel himnusz",
        "Amerikāņu gospelis",
        "Amerikaans gospelnummer",
        "Amerykańska piosenka gospel",
        "Canção gospel americana",
        "Cântec gospel american",
        "Американська пісня в жанрі госпел",
      ],
      [
      ...
      [
        ...
        "Zulu slaapliedje",
        "Kołysanka zuluska",
        "Canção de embalar zulu",
        "Cântec de leagăn Zulu",
        "Зулуська колискова",
      ],
      [
      ...
      [
        ...
        "Canción popular mexicana",
        "Lagu rakyat Meksiko",
        "Mexická lidová píseň",
        "Mexicansk folkesang",
        "Meksička narodna pjesma",
        "Mexikói népdal",
        "Meksikāņu tautas dziesma",
      ...
      [
        ...
        "Canción popular coreana",
        "Chanson populaire coréenne",
        "कोरियन लोक गीत",
        ...
        "Canción popular coreana",
        "Lagu rakyat Korea",
        "Korejská lidová píseň",
        "Koreansk folkesang",
        "Korejska narodna pjesma",
        "Koreai népdal",
        "Korejiešu tautas dziesma",
        "Koreaans volksnummer",
        "Koreańska piosenka ludowa",
        "Canção folclórica coreana",
        "Cântec folk coreean",
        "Корейська народна пісня",
      ],
      [
        "song_han_river_name",
        "Han River",
      ...
      [
        ...
        "Away in a Manger",
        "Away in a Manger",
        "Away in a Manger (Tur Bētlemē, silītē)",
        "Away in a Manger",
        "Away in a Manger",
        "Away in a Manger",
        "Away in a Manger",
      ...
      [
        ...
        "O Come All Ye Faithful",
        "Adeste fideles",
        "O Come All Ye Faithful (Ak, ticīgie, nāciet)",
        "O Come All Ye Faithful",
        "O Come All Ye Faithful",
        "O Come All Ye Faithful",
        "O Come All Ye Faithful",
      ...
      [
        ...
        "Ring in the New Year!",
        "Ring in the New Year!",
        "Să sărbătorim intrarea în noul an!",
      ...
      [
        ...
        "Спойте Auld Lang Syne",
        "Canta Auld Lang Syne",
        "Sing Auld Lang Syne",
        "Zazpívejte si Auld Lang Syne",
        "Syng Auld Lang Syne",
        "Pjevajte Auld Lang Syne",
        "Énekelje a Gyertyafény keringőt",
        "Dziediet dziesmu “Auld Lang Syne”",
        "Zing Auld Lang Syne",
        "Zaśpiewaj Auld Lang Syne",
        "Sing Auld Lang Syne",
        "Cântați Auld Lang Syne",
        "Заспівайте Auld Lang Syne",
      ],
      [
        ...
        "Escucha <song> interpretada por Blob Opera. Luego, reproduce las cuatro voces de ópera para crear tu propia composición 🎼",
        'Écoutez "<song>" interprétée par le Blob Opera. Faites ensuite chanter quatre voix d\'opéra pour créer votre propre œuvre 🎼',
        "वह <song> सुनें जिसे Blob Opera की मदद से, परफ़ॉर्म किया गया है. इसके बाद, अपनी धुन बनाने के लिए, ऑपरा की चार आवाज़ें चलाएं 🎼",
        "Ascolta <song> eseguita da Blob Opera. Poi fai cantare quattro voci liriche per creare la tua composizione",
        "Ouça a canção <song> cantada pela Blob Opera. Em seguida, toque quatro vozes de ópera para criar sua própria composição",
        "Sikiliza <song> unaoimbwa na Blob Opera. Kisha ucheze sauti nne za opera ili utunge wimbo wako mwenyewe 🎼",
        "Blob Opera が歌う <song> を聴いてみましょう。今度は 4 人のオペラの歌声を再生して、自分で作曲してみましょう。 🎼",
        "블롭 오페라가 부르는 <song>을(를) 들어보세요. 그리고 네 개의 오페라 목소리로 직접 작곡해 보세요. 🎼",
        "聆听 Blob Opera 演唱<song>，然后播放 4 种歌剧声音，创作自己的作品 🎼",
        "欣賞 Blob Opera 演唱的〈<song>〉，然後運用四種歌劇人聲創作樂曲",
        "Hören Sie sich <song> an, vorgetragen von Blob Opera. Kreieren Sie dann mit den vier Opernstimmen eine eigene Komposition 🎼",
        'Послушайте композицию "<song>" в исполнении Blob Opera, а затем сочините собственный шедевр для оперного квартета. 🎼',
        "Escucha <song> interpretada por Blob Opera. Luego, reproduce las cuatro voces de ópera para crear tu propia composición 🎼",
        ...
        "Poslechněte si <song> v podání Blob Opera. Potom si hrajte se čtyřmi operními hlasy a vytvořte z nich vlastní skladbu 🎼",
        "Hør <song> af Blob Opera. Afspil derefter fire operastemmer for at skabe din egen komposition 🎼",
        'Slušajte pjesmu <song> u izvedbi Blob Opere. Zatim "svirajte" četiri operna glasa da biste skladali vlastitu skladbu 🎼',
        "Hallgassa meg a(z) <song> című dalt a Blob Opera előadásában. Játsszon négy operaénekes hangján, majd szerezzen saját zenét. 🎼",
        "Klausieties, kā dziesmu <song> atskaņo “Blob Opera” dziedātāji. Pēc tam atskaņojiet četras operdziedātāju balsis, lai sacerētu savu skaņdarbu. 🎼",
        "Luister naar <song> uitgevoerd door Blob Opera. Speel daarna 4 operastemmen af en stel je eigen compositie samen 🎼",
        "Posłuchaj utworu <song> w wykonaniu Blob Opera. Następnie odtwórz 4 głosy operowe i stwórz własną kompozycję 🎼",
        "Ouça <song> interpretada pelo Blob Opera. Em seguida, toque quatro vozes de ópera para criar a sua própria composição 🎼",
        "Ascultați <song> interpretat de Opera cu bule. Apoi redați patru voci de operă pentru a crea propria compoziție 🎼",
        "Послухайте пісню <song> у виконанні Blob Opera, а потім створіть власну композицію для оперного квартету 🎼",
      ],
    ];
  },
  function (e, t, n) {
          ...
          ((r.append = function (e, t) {
            ...
            (r.toString = function () {
              var e,
                ...
                a = [];
              for (t in o)
                for (n = h(t), e = 0, i = o[t]; e < i.length; e++)
                  a.push(n + "=" + h(i[e]));
              return a.join("&");
            }));
          var l = !!o && n && !i && e.Proxy;
          ...
          if ("object" == typeof e)
            ...
            for (var a = e.split("&"), r = 0; r < a.length; r++) {
              var s = a[r],
                l = s.indexOf("=");
              -1 < l
                ? f(t, d(s.slice(0, l)), d(s.slice(l + 1)))
                : s && f(t, d(s), "");
            }
          }
          return t;
  ...
  function (e, t, n) {
    ...
    function i(e, t, n, i) {
      ...
      for (var l in (e.attachShader(a, r), e.attachShader(a, s), i))
        e.bindAttribLocation(a, i[l], l);
      e.linkProgram(a);
      for (
        var u = {}, c = e.getProgramParameter(a, e.ACTIVE_UNIFORMS), h = 0;
        h < c;
        h += 1
      ) {
    ...
    function s(e, t, n, i, o, a, r, s) {
      ...
      return (
        ...
        (a !== e.LINEAR_MIPMAP_LINEAR && a !== e.LINEAR_MIPMAP_NEAREST) ||
    ...
    function l(e, t, n, i) {
      ...
      return (
        ...
        e.renderbufferStorage(e.RENDERBUFFER, t, n, i),
        o
      );
    }
    function u(e, t, n, i) {
      ...
      m = (function () {
        function e(e, t, n) {
          ((this.centerPosition = new Float32Array(3)),
            ...
            (this.module = t),
            (this.eyePointer = n),
            (this.vertexCount = this.module._eyeGetVertexCount(
              this.eyePointer,
            )),
          ...
          (e.prototype.step = function (e, t) {
            ...
            ((this.centerPosition[0] = this.module.HEAPF32[0 + (a >> 2)]),
              (this.centerPosition[1] =
                this.module.HEAPF32[1 + (a >> 2)] + 0.02),
            ...
            var s = Object(d.b)(
                Math.atan2(
                  this.localLookDirection[0],
                  this.localLookDirection[2],
                ),
                -Math.PI / 2,
                (Math.PI / 2) * 0.3,
              ),
              l = Object(d.b)(
                Math.acos(this.localLookDirection[1]),
                t,
                0.5 * Math.PI,
              );
            ((this.lookYaw = Object(d.q)(this.lookYaw, s, 0.5)),
              ...
              (this.lookDirection[0] =
                Math.sin(this.lookPitch) * Math.sin(this.lookYaw)),
              (this.lookDirection[1] = Math.cos(this.lookPitch)),
              (this.lookDirection[2] =
                Math.sin(this.lookPitch) * Math.cos(this.lookYaw)));
          }),
          e
        );
      })(),
      ...
      g = (function () {
        ...
        return (
          ...
          (e.prototype.addLine = function (e, t, n, i) {
            for (var o = 0; o < 3; ++o)
              this.positionsData[3 * this.vertexCount + o] = e[o];
            for (o = 0; o < 3; ++o)
              this.positionsData[3 * this.vertexCount + 3 + o] = t[o];
            for (o = 0; o < 4; ++o)
              this.colorsData[4 * this.vertexCount + o] = n[o];
            for (o = 0; o < 4; ++o)
              this.colorsData[4 * this.vertexCount + 4 + o] = i[o];
            this.vertexCount += 2;
          }),
          (e.prototype.commit = function () {
            var e = this.gl;
      ...
      b = (function () {
        function e(e, t, n, i, o) {
          ...
          for (var a = 0; a < t.length; ++a)
            this.soundingAlphas.push(new p.a(0));
    ...
    var y,
      ...
      k = (function () {
        function e(e, t) {
          ((this.module = e),
            (this.hatPointer = t),
            (this.splinePointCount = this.module._hatGetPointCount(
              this.hatPointer,
            )));
        }
        return (
    ...
    (!(function (e) {
      ((e[(e.Normal = 0)] = "Normal"),
        (e[(e.Christmas = 1)] = "Christmas"),
        (e[(e.NewYears = 2)] = "NewYears"));
    })(y || (y = {})),
      (function (e) {
    ...
    function S(e, t) {
      for (
        var n = e._malloc(t.length),
          i = e.HEAPU8.subarray(n, n + t.length),
          o = 0;
        o < t.length;
        ++o
      )
      ...
      M = (function () {
        function e() {
          ((this.lastBlinkTime = 0),
            (this.lastBlinkTime =
              Date.now() - Object(d.q)(3e3, 6e3, Math.random())),
        ...
        return (
          (e.prototype.step = function (e, t) {
            ...
            ((this.yScale = Math.max(
              1 +
                (this.planeIntersection[1] - this.draggingRestPosition[1]) * n,
              0.5,
            )),
    ...
    var I = (function () {
      function e(e, t, n, i, o, a, r, s, l, h, f) {
        ...
        ((this.config = P(
          P(
            {},
            {
              mouthYScale: 1,
              partyHatHue: 0,
              festiveHatBrimRadius: 0,
              partyHatBrimRadius: 0,
            },
          ),
          s,
        )),
        ...
        var R = {
            ...
            brimRadius:
              f === y.Christmas
                ? s.festiveHatBrimRadius
                : f === y.NewYears
                  ? s.partyHatBrimRadius
                  : 0.01,
        ...
        ((this.blobPointer = this.module._createBlob(
          ...
          (this.vertexCount = this.module._blobGetVertexCount(
            this.blobPointer,
          )),
          (this.renderingVertexCount = this.module._blobGetRenderingVertexCount(
            this.blobPointer,
          )),
          (this.renderingIndexCount = this.module._blobGetRenderingIndexCount(
            this.blobPointer,
          )),
        ...
        w &&
          (this.hat = new k(
            this.module,
            this.module._blobGetHat(this.blobPointer),
          ));
        var N = this.module._blobGetRestMouthCentroid(this.blobPointer);
        if (
          ((this.restMouthCentroid = this.module.HEAPF32.subarray(
            N >> 2,
            3 + (N >> 2),
          ).slice(0)),
          h)
          ...
          var G = new Float32Array(
            A(s.position, 0, Object(d.e)(s.rotationDegrees), 1),
          );
          this.baseModelMatrix = c.premultiply(
            new Float32Array(16),
            G,
            A(l, 0, 0, 1),
          );
        } else
          this.baseModelMatrix = new Float32Array(
            A(s.position, 0, Object(d.e)(s.rotationDegrees), 1),
          );
        this.mouthTriangleIndexCount =
          this.module._blobGetMouthTriangleIndexCount(this.blobPointer);
        var H = this.module.HEAPU16.subarray(
          this.module._blobGetMouthTriangleIndices(this.blobPointer) >> 1,
          (this.module._blobGetMouthTriangleIndices(this.blobPointer) >> 1) +
            this.mouthTriangleIndexCount,
        );
        ((this.mouthTriangleIndexBuffer = u(
          e,
          e.ELEMENT_ARRAY_BUFFER,
          H,
          e.STATIC_DRAW,
        )),
          (this.mouthPositionCount = this.module._blobGetMouthPositionCount(
            this.blobPointer,
          )),
          ...
          (this.tonguePositionCount = this.module._tongueGetPointCount(
            this.tonguePointer,
          )),
          ...
          (this.MIN_Y =
            ...
            (2.5 / this.scale.length) * (4.4 * 0.9)),
          (this.MAX_Y = this.MIN_Y + 4.4 * 0.9));
        var U = T(
            [0, 0, this.restMouthCentroid[2] + 0.65],
        ...
        ((this.tongueScale = new Float32Array([J, 1 / J])),
          (this.mouthUVs = this.module.HEAPF32.subarray(
            ...
            (this.module._blobGetMouthUVs(this.blobPointer) >> 2) +
              2 * this.mouthPositionCount,
          ).slice(0)));
      }
      return (
        (e.prototype.recomputeMatrices = function () {
          var e = c.makeTranslation(
            this.tempMatrix,
            this.offset[0],
            this.offset[1],
            this.offset[2],
        ...
        (e.prototype.startFalling = function (e) {
          this.state !== E.Falling &&
            ((this.fallStartFrame =
              this.frame + (this.state === E.Rising ? 0 : e)),
            this.state === E.Rising
              ? (this.fallStartY = this.getRiseY())
              : (this.fallStartY = 12),
            (this.state = E.Falling),
        ...
        (e.prototype.startRising = function (e) {
          this.state !== E.Rising &&
            (this.state === E.Falling
              ? (this.riseStartY = this.getFallY())
              : (this.riseStartY = 0),
            (this.riseStartFrame =
              this.frame + (this.state === E.Falling ? 0 : e)),
            (this.state = E.Rising),
            (this.offset[1] = 0),
            this.recomputeMatrices());
        }),
        (e.prototype.exitStageLeft = function () {
          this.exiting ||
            ((this.exiting = !0), (this.exitStartFrame = this.frame));
        }),
        ...
        (e.prototype.getFallVelocity = function () {
          if (this.state === E.Falling) {
            return (
              Math.max(0, this.frame - this.fallStartFrame) * e.GRAVITY - 0.02
            );
          }
          return 0;
        }),
        (e.prototype.getRiseY = function () {
          ...
          return (
            this.riseStartY +
            e.INITIAL_RISE_SPEED * t +
            0.5 * e.RISE_ACCELERATION * t * t
          );
        }),
        (e.prototype.step = function (t, n) {
          ...
          (this.mouthScaleX.change(i.scale[0], 0.1),
            ...
            this.mouthRotation.change(
              n ? 1 * this.config.mouthRotation : this.config.mouthRotation,
              0.1,
            ));
          ...
          if (
            ...
            this.module._blobSetMouthBend(
              this.blobPointer,
              this.mouthBend.evaluate(),
            ),
            ...
            this.module._blobSetMouthNoiseOffset(
              this.blobPointer,
              0.05 * this.frame,
            ),
            this.module._blobSetMouthRotation(
              this.blobPointer,
              this.mouthRotation.evaluate(),
            ),
            (this.isSinging = n && !n.getMuted()),
            this.isSinging)
          ) {
            if (
              Object(d.n)(n.getVowel()) &&
              n.getVowel() !== this.lastSoundedVowel
            ) {
            ...
            ((this.lastSoundedVowel = _.b.sil),
              this.eyeOverrideOpenness.change(0, 0.2));
          ...
          if (this.state === E.Idle)
            if (t.length > 0) {
              ...
              var p = n.getF0(),
                ...
                f = (function (e, t) {
                  ...
                  for (var n = 0; n < t.length - 1; ++n)
                    if (e >= t[n] && e <= t[n + 1])
                      return n + Object(d.o)(t[n], t[n + 1], e);
                })(m, this.scale),
              ...
              if (n.getControlled())
                v =
                  ((F.lastIndexOf(this.lastSoundedVowel) - 1) /
                    (F.length - 1)) *
                  0.1;
              ((this.zOffset = Object(d.q)(this.zOffset, v, 0.3)),
                this.liveMidiNote.change(m, 0));
            }
          ...
          if (this.exiting) {
            var k = Math.max(0, this.frame - this.exitStartFrame),
              w =
                0 -
                e.INITIAL_RISE_SPEED * k -
                0.5 * e.RISE_ACCELERATION * 3 * k * k;
            this.offset[0] = w;
          ...
          if (
            ...
            var L = {
              ...
              vowel: z(
                F,
                Object(d.o)(this.MIN_Z, this.MAX_Z, M[2]),
          ...
          for (var O = 0, I = this.eyes; O < I.length; O++) {
            I[O].step(
              this.localLookPosition,
              Math.PI / 2 - this.getTopEyelidAngleWithoutBlink(),
            );
          }
        ...
        (e.prototype.getBottomEyelidAngle = function () {
          return (
            this.blinker.evaluate() *
            this.eyeBottomOpenness.evaluate() *
            Math.PI *
            0.5
          );
        }),
          ...
          return (
            Math.max(
              ...
              Object(d.q)(
                0,
                1,
                this.eyeTopOpenness.evaluate() -
                  this.eyeOverrideOpenness.evaluate(),
              ),
            ) *
            Math.PI *
            0.5
        ...
        (e.prototype.getTopEyelidAngle = function () {
          return Object(d.q)(
            0,
            this.getTopEyelidAngleWithoutBlink(),
            this.blinker.evaluate(),
          );
        }),
        ...
        (e.prototype.getTopPosition = function () {
          for (var e = 0; e < 3; ++e)
            this.topPosition[e] =
              0.5 *
              (this.eyes[0].attachPosition[e] + this.eyes[1].attachPosition[e]);
    ...
    function V(e, t, n) {
      var i = Object(d.s)(-10, 10),
        ...
        a = Object(d.s)(-10, 10);
      (0 === n
        ? (i = (-t.d - t.b * o - t.c * a) / t.a)
        : 1 === n && (o = (-t.d - t.a * i - t.c * a) / t.b),
        (e[0] = i),
        (e[1] = o),
        (e[2] = a));
    }
      ...
      q = (function () {
        function e(e, t, n, i, o, a, r) {
          ...
          ((this.randomBuffer = u(
            ...
            (this.spawnPositionData = new Float32Array(
              4 * this.particleCount * 3,
            )),
            this.useVelocity &&
              (this.spawnVelocityData = new Float32Array(
                4 * this.particleCount * 3,
              )),
        ...
        return (
          (e.prototype.spawn = function (e, t, n, i, o) {
            if (0 !== t) {
              this.nextSpawnIndex + t >= this.particleCount &&
                (this.nextSpawnIndex = 0);
              for (var a = 0; a < t; ++a) {
                var r =
                    this.spawnDirections[
                      Math.floor(Math.random() * this.spawnDirections.length)
                    ],
                  s = 0.5 * Math.PI,
                ...
                ("left" === r
                  ...
                  : "right" === r
                    ...
                    : "top" === r
                      ...
                      : "bottom" === r &&
                        (G(this.plane, i), (u = Math.PI / 2 + l)),
                  "left" === r || "right" === r
                    ? V(this.spawnPosition, this.plane, 0)
                    : ("bottom" !== r && "top" !== r) ||
                      V(this.spawnPosition, this.plane, 1));
                for (
                  var c = Object(d.s)(0.01, 0.1),
                    h =
                      e - Math.random() * n - (this.particleCount - 1 - a) * o,
                    p = 0;
                  p < 4;
                  ++p
                )
                  ((this.spawnTimeData[4 * a + p] = h),
                    (this.spawnPositionData[4 * a * 3 + 3 * p + 0] =
                      this.spawnPosition[0]),
                    (this.spawnPositionData[4 * a * 3 + 3 * p + 1] =
                      this.spawnPosition[1]),
                    (this.spawnPositionData[4 * a * 3 + 3 * p + 2] =
                      this.spawnPosition[2]),
                    this.useVelocity &&
                      ((this.spawnVelocityData[4 * a * 3 + 3 * p + 0] =
                        Math.cos(u) * c),
                      (this.spawnVelocityData[4 * a * 3 + 3 * p + 1] =
                        Math.sin(u) * c),
    ...
    function K(e, t, n) {
      var i = [],
        o = 0;
      function a(e, t, n) {
        for (var a = 9 * e, r = 0; r < 16; ++r)
          (i.push(r), i.push(a), i.push(t), i.push(n));
        o += 1;
      }
    ...
    function ee(e, t) {
      var n = (function (e) {
          for (
            var t = e > 20 ? 3 : 2, n = [], i = (2 * t) / (e - 1), o = 0;
            o < e;
            ++o
          ) {
            var a = o * i - t,
          ...
          for (o = 0; o < e; ++o) {
            var u =
              ((o > 0 ? Math.abs(n[o] - n[o - 1]) : 0) +
                (o < e - 1 ? Math.abs(n[o] - n[o + 1]) : 0)) /
              2;
        ...
        o = (function (e) {
          for (var t = 1; t < e.length; ++t)
            if (!Object(d.a)(e[0], e[t])) return !1;
          return !0;
        })(t),
        a =
      ...
      ae = (function () {
        function e(e, t, n, i) {
          ((this.gl = e),
            ...
            (this.spawnPosition = t),
            (this.spawnTime = i));
          for (
            var o = h.a.normalize([], h.a.cross([], n, [0, 1, 0])),
              a = h.a.cross([], o, n),
              r = [],
              s = 0;
    ...
    function re(e) {
      var t = Object(d.s)(0, 2 * Math.PI),
        n = Object(d.s)(-1, 1);
      ((e[0] = Math.sqrt(1 - n * n) * Math.cos(t)),
        (e[1] = Math.sqrt(1 - n * n) * Math.sin(t)),
        (e[2] = n));
    }
    var se =
      ...
      fe = function (e, t, n, i, o, r) {
        ...
        ((this.position = new Float32Array([
          ...
          this.shadowsEnabled &&
            ...
            (this.projectionMatrix = c.makePerspective(
              new Float32Array(16),
              Math.PI / 8,
              1,
              0.5,
    ...
    var ge = (function () {
        function e(e, t, n, o, r, s, h, m, f) {
              ...
              "\nprecision highp float;\n\n#define PI 3.14159265358979323846\n\nuniform vec3 u_cameraPosition;\n\nuniform float u_gamma;\n\nuniform vec3 u_lightPosition0;\nuniform vec3 u_lightColor0;\nuniform mat4 u_lightProjectionViewMatrix0;\nuniform sampler2D u_shadowDepthTexture0;\nuniform vec2 u_shadowResolution0;\n\nuniform vec3 u_lightPosition1;\nuniform vec3 u_lightColor1;\nuniform mat4 u_lightProjectionViewMatrix1;\nuniform sampler2D u_shadowDepthTexture1;\nuniform vec2 u_shadowResolution1;\n\nuniform vec3 u_lightPosition2;\nuniform vec3 u_lightColor2;\n\nfloat square (float x) {\n    return x * x;\n}\n\nfloat fresnel (float F0, float lDotH) {\n    float f = pow(1.0 - lDotH, 5.0);\n\n    return (1.0 - F0) * f + F0;\n}\n\nfloat GGX (float alpha, float nDotH) {\n    float a2 = square(alpha);\n\n    return a2 / (PI * square(square(nDotH) * (a2 - 1.0) + 1.0));\n}\n\nfloat GGGX (float alpha, float nDotL, float nDotV) {\n    float a2 = square(alpha);\n\n    float gl = nDotL + sqrt(a2 + (1.0 - a2) * square(nDotL));\n    float gv = nDotV + sqrt(a2 + (1.0 - a2) * square(nDotV));\n\n    return 1.0 / (gl * gv);\n}\n\nfloat saturate (float x) {\n    return clamp(x, 0.0, 1.0);\n}\n\nfloat specularBRDF (vec3 lightDirection, vec3 eyeDirection, vec3 normal, float roughness, float F0) {\n    vec3 halfVector = normalize(lightDirection + eyeDirection);\n\n    float nDotH = saturate(dot(normal, halfVector));\n    float nDotL = saturate(dot(normal, lightDirection));\n    float nDotV = saturate(dot(normal, eyeDirection));\n    float lDotH = saturate(dot(lightDirection, halfVector));\n\n    float D = GGX(roughness, nDotH);\n    float G = GGGX(roughness, nDotL, nDotV);\n    float F = fresnel(F0, lDotH);\n\n    return smoothstep(-0.2, 0.0, dot(lightDirection, normal)) * D * G * F;\n}\n\n\nconst float PackUpscale = 256.0 / 255.0;\nconst float UnpackDownscale = 255.0 / 256.0;\n\nconst vec3 PackFactors = vec3( 256.0 * 256.0 * 256.0, 256.0 * 256.0,  256.0);\nconst vec4 UnpackFactors = UnpackDownscale / vec4(PackFactors, 1.0);\n\nconst float ShiftRight8 = 1.0 / 256.0;\n\nfloat unpackRGBAToDepth(const in vec4 v) {\n    return dot(v, UnpackFactors);\n}\n\nfloat texture2DCompare( sampler2D depths, vec2 uv, float compare ) {\n    return step(compare, unpackRGBAToDepth(texture2D( depths, uv)));\n}\n\nfloat texture2DShadow(sampler2D depths, vec2 size, vec2 uv, float compare) {\n    return texture2DCompare(depths, uv, compare);\n}\n\nfloat getShadow (vec3 worldPosition, vec3 worldNormal, mat4 projectionViewMatrix, sampler2D depthTexture, vec2 resolution) {\n    vec4 lightSpacePosition = projectionViewMatrix * vec4(worldPosition + worldNormal * 0.00001, 1.0);\n    lightSpacePosition /= lightSpacePosition.w;\n    lightSpacePosition = lightSpacePosition * 0.5 + 0.5;\n    vec2 lightSpaceCoordinates = lightSpacePosition.xy;\n\n    <shadow>\n}\n\nvec3 shadeSurfaceWithLightWithoutShadow(vec3 worldPosition, vec3 worldNormal, vec3 albedo, float roughness, float F0, vec3 lightPosition, vec3 lightColor) {\n    vec3 lightDirection = normalize(lightPosition - worldPosition);\n    vec3 eyeDirection = normalize(u_cameraPosition - worldPosition);\n\n    float diffuse = saturate(dot(lightDirection, worldNormal));\n    float specular = specularBRDF(lightDirection, eyeDirection, worldNormal, roughness, F0);\n\n    vec3 color = (diffuse * albedo + vec3(specular)) * lightColor;\n\n    return color;\n}\n\nvec3 shadeSurfaceWithLight (vec3 worldPosition, vec3 normal, vec3 albedo, float roughness, float F0, vec3 lightPosition, vec3 lightColor, mat4 projectionViewMatrix, sampler2D depthTexture, vec2 depthResolution) {\n    float shadow = getShadow(worldPosition, normal, projectionViewMatrix, depthTexture, depthResolution);\n    vec3 color = shadeSurfaceWithLightWithoutShadow(worldPosition, normal, albedo, roughness, F0, lightPosition, lightColor) * shadow;\n    return color;\n}\n\n#define AMBIENT 0.05\n\nvec3 shadeSurfaceWithLights(vec3 worldPosition, vec3 worldNormal, vec3 albedo, float roughness, float F0) {\n    vec3 total = vec3(0.0);\n    total += shadeSurfaceWithLight(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition0, u_lightColor0, u_lightProjectionViewMatrix0, u_shadowDepthTexture0, u_shadowResolution0);\n    total += shadeSurfaceWithLight(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition1, u_lightColor1, u_lightProjectionViewMatrix1, u_shadowDepthTexture1, u_shadowResolution1);\n    total += shadeSurfaceWithLightWithoutShadow(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition2, u_lightColor2);\n    total += AMBIENT * albedo;\n    return total;\n}\n\nvec3 shadeSurfaceWithLightsWithoutShadow(vec3 worldPosition, vec3 worldNormal, vec3 albedo, float roughness, float F0) {\n    vec3 total = vec3(0.0);\n    total += shadeSurfaceWithLightWithoutShadow(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition0, u_lightColor0);\n    total += shadeSurfaceWithLightWithoutShadow(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition1, u_lightColor1);\n    total += shadeSurfaceWithLightWithoutShadow(worldPosition, worldNormal, albedo, roughness, F0, u_lightPosition2, u_lightColor2);\n    total += AMBIENT * albedo;\n    return total;\n}\n\nfloat getShadowFromLights(vec3 worldPosition) {\n    float total = 1.0;\n    total *= getShadow(worldPosition, vec3(0.0, 1.0, 0.0), u_lightProjectionViewMatrix0, u_shadowDepthTexture0, u_shadowResolution0);\n    total *= getShadow(worldPosition, vec3(0.0, 1.0, 0.0), u_lightProjectionViewMatrix1, u_shadowDepthTexture1, u_shadowResolution1);\n    return total;\n}\n\n#define SSS_INDEX_COUNT 32\nfloat getSSSAlpha(int sssIndex) {\n    return float(sssIndex + 1) / float(SSS_INDEX_COUNT);\n}\n\nint sssAlphaToIndex(float sssAlpha) {\n    return int(sssAlpha * float(SSS_INDEX_COUNT) - 0.99);\n}\n\n#ifdef HAS_STANDARD_DERIVATIVES\nmat3 cotangentFrame(vec3 N, vec3 p, vec2 uv) {\n    // get edge vectors of the pixel triangle\n    vec3 dp1 = dFdx(p);\n    vec3 dp2 = dFdy(p);\n    vec2 duv1 = dFdx(uv);\n    vec2 duv2 = dFdy(uv);   \n    // solve the linear system \n    vec3 dp2perp = cross(dp2, N);\n    vec3 dp1perp = cross(N, dp1);\n    vec3 T = dp2perp * duv1.x + dp1perp * duv2.x;\n    vec3 B = dp2perp * duv1.y + dp1perp * duv2.y;\n    // construct a scale-invariant frame\n    float invmax = inversesqrt(max(dot(T, T), dot(B, B)));\n    return mat3(T * invmax, B * invmax, N);\n}\n#endif\n\n".replace(
                ...
                (function (e, t) {
                  for (
                    ...
                    var r = n[a],
                      s =
                        "vec2(" + r[0].toFixed(8) + "," + r[1].toFixed(8) + ")";
                    i.push(
                      "shadow += " +
                        o.toFixed(8) +
          ...
          var v,
            x =
              "\nprecision highp float;\n\nvarying vec2 v_uv;\n\nvarying vec4 v_clipSpacePosition;\nvarying vec4 v_referenceClipSpacePosition;\nuniform sampler2D u_texture;\nuniform sampler2D u_newTexture;\n\nuniform float u_transitionT;\n\nuniform vec2 u_screenResolution;\nuniform vec2 u_imageResolution;\n\nuniform float u_zoom;\n\nuniform float u_intensity;\nuniform float u_time;\n\nuniform vec2 u_fov;\nuniform float u_yScale;\n\nvec3 hsv2rgb(vec3 c) {\n    vec4 K = vec4(1.0, 2.0 / 3.0, 1.0 / 3.0, 3.0);\n    vec3 p = abs(fract(c.xxx + K.xyz) * 6.0 - K.www);\n    return c.z * mix(K.xxx, clamp(p - K.xxx, 0.0, 1.0), c.y);\n}\n\nvec3 rgb2hsv(vec3 c) {\n    vec4 K = vec4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);\n    vec4 p = mix(vec4(c.bg, K.wz), vec4(c.gb, K.xy), step(c.b, c.g));\n    vec4 q = mix(vec4(p.xyw, c.r), vec4(c.r, p.yzx), step(p.x, c.r));\n\n    float d = q.x - min(q.w, q.y);\n    float e = 1.0e-10;\n    return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);\n}\n\nvec2 cover(vec2 uv, vec2 s, vec2 i) {\n    float imageRatio = i.y / i.x;\n    float screenRatio = s.y / s.x;\n\n    vec2 imageDimensions = screenRatio > imageRatio ?\n        vec2(s.y / imageRatio, s.y) :\n        vec2(s.x, s.x * imageRatio);\n\n    vec2 imageOrigin = s * 0.5 - imageDimensions * vec2(1.0, 1.0) * 0.5;\n    vec2 result = (((vec2(uv.x, 1.0 - uv.y) * s)) - imageOrigin) / imageDimensions;\n    result.y = result.y;\n    return result;\n}\n\nfloat rand(vec2 co){\n    return fract(sin(dot(co.xy ,vec2(12.9898,78.233))) * 43758.5453);\n}\n\n#ifdef BLUR\n<sample_blurred_u_texture>\n<sample_blurred_u_newTexture>\n#endif\n\nvoid main () {\n    vec2 referenceTextureCoordinates = (v_referenceClipSpacePosition.xy / v_referenceClipSpacePosition.w);\n\n    float targetFOV = 0.3926991 * 2.5;\n    referenceTextureCoordinates *= u_fov / targetFOV;\n    referenceTextureCoordinates.xy *= u_yScale;\n    referenceTextureCoordinates = referenceTextureCoordinates * 0.5 + 0.5;\n\n    referenceTextureCoordinates.y += 0.075;\n\n    #ifdef BLUR\n    float OFFSET = 0.3;\n    float BLUR_WIDTH = 0.12;\n    vec4 color = sampleBlurredTexture(referenceTextureCoordinates + vec2(u_transitionT * OFFSET, 0.0), u_transitionT * BLUR_WIDTH);\n    vec4 newColor = sampleBlurredNewTexture(referenceTextureCoordinates + vec2(-(1.0 - u_transitionT) * OFFSET, 0.0), (1.0 - u_transitionT) * BLUR_WIDTH);\n    //vec4 newColor = texture2D(u_newTexture, referenceTextureCoordinates);\n    color = mix(color, newColor, u_transitionT);\n    #else\n    vec4 color = texture2D(u_newTexture, referenceTextureCoordinates);\n    #endif\n\n    color.rgb = vec3(0.5) + (color.rgb - 0.5) * 1.0;\n\n    vec3 hsv = rgb2hsv(color.rgb);\n    hsv.g *= 0.85;\n    hsv.b *= 0.85;\n    hsv.g *= mix(1.0, 1.5, u_intensity * (1.0 - color.a));\n    //hsv.z *= mix(1.0, 0.5, u_intensity * (1.0 - color.a));\n\n    vec3 finalColor = hsv2rgb(hsv);\n\n    vec2 textureCoordinates = (v_clipSpacePosition.xy / v_clipSpacePosition.w) * 0.5 + 0.5;\n    vec3 direction = normalize(vec3(\n    \t(textureCoordinates * 2.0 - 1.0) * mix(0.001, 1.0, u_intensity),\n    \t-1.0));\n\n    float factor = pow(max(-direction.z, 0.0), 4.0);\n    finalColor *= mix(factor, 1.0, color.a);\n\n    gl_FragColor = vec4(finalColor, 1.0);\n\n   // gl_FragColor = vec4(vec3(factor * 0.3), 1.0);\n}\n"
                .replace(
                  "<sample_blurred_u_texture>",
                  ce((v = 5), "u_texture", "sampleBlurredTexture"),
                )
                .replace(
                  "<sample_blurred_u_newTexture>",
          ...
          ((this.backgroundProgram = i(t, ue, x, { a_position: 0 })),
            ...
            this.lights.push(
              new fe(t, 0.65 * -Math.PI, 0 * Math.PI, 20, 1.5, !0),
            ),
            this.lights.push(
              new fe(t, 0.2 * Math.PI, 0 * Math.PI, 20, 0.2, !0),
            ),
            this.lights.push(
              new fe(t, 0.75 * Math.PI, 0 * Math.PI, 20, 0.1, !1),
            ),
            ...
            (this.tongueGeometry = (function (e) {
                ...
                for (
                  var i = n / 19.5,
                    o =
                      i < 0.5
                        ? 1
                        : Math.sqrt(1 - Math.pow(Object(d.o)(0.5, 1, i), 2)),
                    a = 0;
                  a < 16;
                  ++a
                ) {
              ...
              for (a = 1; a < 15; ++a)
                (s.push(304), s.push(304 + a), s.push(304 + a + 1));
            ...
            (this.mouthInsideGeometry = (function (e) {
              for (var t = [], n = 0; n < 20; ++n)
                for (var i = 0; i < 16; ++i) t.push(i / 16, n / 19);
            ...
            this.festiveScene.kind === y.Christmas
              ...
              : this.festiveScene.kind === y.NewYears &&
                (this.setStaticLightingUniforms(this.festiveScene.hatProgram),
                this.setStaticLightingUniforms(
                  this.festiveScene.confettiProgram,
                ),
                this.setStaticLightingUniforms(
                  this.festiveScene.poppedConfettiProgram,
                ),
                this.setStaticLightingUniforms(
                  this.festiveScene.balloonProgram,
                )),
        ...
        return (
          ...
          (e.prototype.recalculateProjectionMatrix = function () {
            ...
            if (n < 1) {
              ...
              ((e = 2 * Math.atan((1 / n) * Math.tan(i / 2))),
                (e = Math.min(e, 0.9 * Math.PI)));
            }
            ((this.currentVerticalFOV = e),
              ...
              c.makeInfinitePerspective(
                this.referenceProjectionMatrix,
                e,
                1,
                0.01,
                100,
          ...
          (e.prototype.setSSSColors = function (e) {
            var t = this.gl;
            ((this.sssBlurProgram = i(t, me, ee(17, e), { a_position: 0 })),
              console.log(e));
          }),
          ...
          (e.prototype.setStaticLightingUniforms = function (e) {
            ...
            for (var n = 0; n < this.lights.length; ++n) {
              var i = this.lights[n];
              (t.uniform3fv(
                e.uniformLocations["u_lightPosition" + n.toFixed(0)],
                i.position,
              ),
                t.uniform3fv(
                  e.uniformLocations["u_lightColor" + n.toFixed(0)],
                  i.color,
                ),
                i.shadowsEnabled &&
                  (t.uniform2f(
                  ...
                  t.uniformMatrix4fv(
                    e.uniformLocations[
                      "u_lightProjectionViewMatrix" + n.toFixed(0)
                    ],
                    !1,
                    i.projectionViewMatrix,
                  ),
                  t.uniform1i(
                    e.uniformLocations["u_shadowDepthTexture" + n.toFixed(0)],
                    3 + n,
                  )));
            }
          }),
          ...
          (e.prototype.changeScene = function (e, t, n) {
            (this.gl.deleteTexture(this.backgroundTexture),
              ...
              (this.newBackgroundTexture = this.generateBackgroundTexture(
                e,
                t,
              )),
          ...
          (e.prototype.render = function (e) {
              ...
              if (u.shadowsEnabled) {
                ...
                for (var b = 0, v = e; b < v.length; b++) {
                  (J = v[b]).state !== E.Offscreen &&
                    ...
                    r.bindBuffer(
                      ...
                      J.mouthGeometry.indexBuffer,
                    ),
                    r.drawElements(
                      r.TRIANGLES,
                      J.mouthGeometry.indexCount,
                      r.UNSIGNED_SHORT,
                      0,
                    ));
                }
                if (
                  ...
                  (r.useProgram(x.program),
                    ...
                    r.uniformMatrix4fv(
                      x.uniformLocations.u_viewMatrix,
                      !1,
                      u.viewMatrix,
                    ),
                    r.enableVertexAttribArray(0),
            ...
            (r.bindFramebuffer(r.FRAMEBUFFER, this.framebuffer),
              ...
              r.uniform3fv(
                this.blobProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.blobProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
            ...
            for (var P = 0; P < e.length; ++P) {
              if ((J = e[P]).state !== E.Offscreen) {
                (r.activeTexture(r.TEXTURE0),
                  r.bindTexture(
                    r.TEXTURE_2D,
                    e[P].assets.bodyMaterial.albedoTexture,
                  ),
                  r.activeTexture(r.TEXTURE1),
                  r.bindTexture(
                    r.TEXTURE_2D,
                    e[P].assets.bodyMaterial.materialMap,
                  ),
                  r.uniform1i(
                    this.blobProgram.uniformLocations.u_blobIndex,
                    P % 4,
                  ),
                  r.uniform1f(
                  ...
                  r.uniform1f(
                    this.blobProgram.uniformLocations.u_f0,
                    J.assets.bodyMaterial.f0,
                  ),
                  r.uniform1f(
                ...
                (r.uniform3f(
                  this.blobProgram.uniformLocations.u_rimColor,
                  S,
                  S,
                  S,
                ),
            ...
            (r.disable(r.CULL_FACE),
              ...
              r.uniform3fv(
                this.eyeProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.eyeProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
            ...
            for (P = 0; P < e.length; ++P) {
              if ((J = e[P]).state !== E.Offscreen) {
                (r.uniform1i(
                  this.eyeProgram.uniformLocations.u_blobIndex,
                  P % 4,
                ),
                  r.uniformMatrix4fv(
                  ...
                  r.uniform1f(
                    this.eyeProgram.uniformLocations.u_f0,
                    J.assets.bodyMaterial.f0,
                  ),
                  r.uniform1f(
                ...
                for (var A = J.eyes.length - 1; A >= 0; --A) {
                  g = J.eyes[A];
                  (r.uniform3fv(
                    this.eyeProgram.uniformLocations.u_eyePosition,
                    g.attachPosition,
                  ),
                    r.uniform3fv(
                      this.eyeProgram.uniformLocations.u_lookDirection,
                      g.lookDirection,
                    ),
                    r.bindBuffer(r.ARRAY_BUFFER, g.positionsBuffer),
                    r.vertexAttribPointer(0, 3, r.FLOAT, !1, 0, 0),
            ...
            (r.depthMask(!0),
              ...
              r.uniform3fv(
                this.mouthProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.mouthProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.uniform1i(
                this.mouthProgram.uniformLocations.u_albedoTexture,
                0,
              ),
              r.enableVertexAttribArray(0),
              r.enableVertexAttribArray(1),
            ...
            for (P = 0; P < e.length; ++P) {
              (J = e[P]).state !== E.Offscreen &&
                (r.uniform1i(
                  this.mouthProgram.uniformLocations.u_blobIndex,
                  P % 4,
                ),
                r.uniform3fv(
                  this.mouthProgram.uniformLocations.u_color,
                  J.assets.mouthColor,
                ),
                r.uniform3fv(
                ...
                r.uniform1f(
                  this.mouthProgram.uniformLocations.u_lipScale,
                  J.config.lipScale,
                ),
                r.uniformMatrix4fv(
                  this.mouthProgram.uniformLocations.u_modelMatrix,
                  !1,
                  J.modelMatrix,
                ),
                r.uniform1i(
                  this.mouthProgram.uniformLocations.u_vertexCount,
                  J.mouthPositionCount,
                ),
                r.uniform3fv(
            ...
            (r.depthMask(!0),
              ...
              r.uniformMatrix4fv(
                this.throatProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.uniform1i(
                this.throatProgram.uniformLocations.u_albedoTexture,
                0,
              ),
              r.enableVertexAttribArray(0),
              r.bindBuffer(
                r.ARRAY_BUFFER,
                this.mouthInsideGeometry.vertexBuffer,
              ),
              r.vertexAttribPointer(0, 2, r.FLOAT, !1, 0, 0),
              r.bindBuffer(
                r.ELEMENT_ARRAY_BUFFER,
                this.mouthInsideGeometry.indexBuffer,
              ),
            ...
            for (P = 0; P < e.length; ++P) {
              (J = e[P]).state !== E.Offscreen &&
                ...
                r.uniform1i(
                  this.throatProgram.uniformLocations.u_blobIndex,
                  P % 4,
                ),
                r.uniform1i(
                  this.throatProgram.uniformLocations.u_vertexCount,
                  J.mouthPositionCount,
                ),
                r.uniform3fv(
                ...
                r.uniform2fv(
                  this.throatProgram.uniformLocations["u_uvs[0]"],
                  J.mouthUVs,
                ),
                r.uniform3f(
                ...
                r.bindTexture(
                  r.TEXTURE_2D,
                  J.assets.bodyMaterial.albedoTexture,
                ),
                r.stencilFunc(r.EQUAL, 1 << (e.length - 1 - P), 4294967295),
                r.drawElements(
                  r.TRIANGLES,
                  this.mouthInsideGeometry.indexCount,
                  r.UNSIGNED_SHORT,
                  0,
                ));
            }
            (r.useProgram(this.tongueProgram.program),
              r.uniform3fv(
                this.tongueProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.tongueProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.enableVertexAttribArray(0),
              ...
              r.bindBuffer(
                r.ELEMENT_ARRAY_BUFFER,
                this.tongueGeometry.indexBuffer,
              ));
            for (P = 0; P < e.length; ++P) {
              (J = e[P]).state !== E.Offscreen &&
                (r.uniformMatrix4fv(
                ...
                r.uniform2fv(
                  this.tongueProgram.uniformLocations.u_scale,
                  J.tongueScale,
                ),
                r.uniform3fv(
                ...
                r.drawElements(
                  r.TRIANGLES,
                  this.tongueGeometry.indexCount,
                  r.UNSIGNED_SHORT,
                  0,
                ));
            }
            if (
              ...
              (r.useProgram(T.program),
                r.uniform3fv(
                  T.uniformLocations.u_cameraPosition,
                  this.cameraPosition,
                ),
                r.uniformMatrix4fv(
                  T.uniformLocations.u_projectionMatrix,
                  !1,
                  this.projectionMatrix,
                ),
                r.uniformMatrix4fv(
                  T.uniformLocations.u_viewMatrix,
                  !1,
                  this.viewMatrix,
                ),
                r.enableVertexAttribArray(0),
              ...
              for (var M = 0, R = e; M < R.length; M++) {
                null !== (J = R[M]).hat &&
                  ...
                  J.state !== E.Offscreen &&
                  (r.uniformMatrix4fv(
                    T.uniformLocations.u_modelMatrix,
                    !1,
                    J.getHatModelMatrix(),
                  ),
                  r.uniform3fv(
                    T.uniformLocations["u_profilePoints[0]"],
                    J.hat.getBrimPositions(),
                  ),
                  r.uniform3fv(
                  ...
                  r.uniform3fv(
                    T.uniformLocations["u_splineTangents[0]"],
                    J.hat.getSplineTangents(),
                  ),
                  r.uniform3fv(
                    T.uniformLocations["u_splineNormals[0]"],
                    J.hat.getSplineNormals(),
                  ),
                  r.uniform1f(
                    T.uniformLocations.u_brimRadius,
                    J.config.parameters.brimRadius,
                  ),
                  r.uniform1f(
            ...
            if (
              ...
              (r.useProgram(C.program),
                r.uniform3fv(
                  C.uniformLocations.u_cameraPosition,
                  this.cameraPosition,
                ),
                r.uniformMatrix4fv(
                  C.uniformLocations.u_projectionMatrix,
                  !1,
                  this.projectionMatrix,
                ),
                r.uniformMatrix4fv(
                  C.uniformLocations.u_viewMatrix,
                  !1,
                  this.viewMatrix,
                ),
                r.uniform1f(C.uniformLocations.u_time, t),
                r.uniform1f(
                  C.uniformLocations.u_intensity,
                  this.backgroundIntensity.evaluate(),
                ),
              ...
              (r.disableVertexAttribArray(1),
                ...
                r.uniform3fv(
                  B.uniformLocations.u_cameraPosition,
                  this.cameraPosition,
                ),
                r.uniformMatrix4fv(
                  B.uniformLocations.u_projectionMatrix,
                  !1,
                  this.projectionMatrix,
                ),
                r.uniformMatrix4fv(
                  B.uniformLocations.u_viewMatrix,
                  !1,
                  this.viewMatrix,
                ),
                r.uniform1f(
                  B.uniformLocations.u_intensity,
                  this.backgroundIntensity.evaluate(),
                ),
                r.enableVertexAttribArray(0),
              ...
              for (P = 0; P < z.balloons.length; ++P) {
                ...
                (r.uniformMatrix4fv(
                  ...
                  r.uniform3fv(
                    B.uniformLocations.u_bottomPoint,
                    j.rigidMesh.bottomPoint,
                  ),
            ...
            (r.framebufferTexture2D(
              ...
              r.uniform1i(
                this.sssBlurProgram.uniformLocations.u_colorTexture,
                0,
              ),
              r.uniform2f(
              ...
              r.uniform2f(
                this.sssBlurProgram.uniformLocations.u_direction,
                1,
                0,
              ),
              r.uniform1i(
                this.sssBlurProgram.uniformLocations.u_gammaCorrect,
                0,
              ),
            ...
            i
              ? this.backgroundIntensity.change(1, 2.5)
              : this.backgroundIntensity.change(0, 1);
            var L =
            ...
            (r.useProgram(L.program),
              r.uniformMatrix4fv(
                L.uniformLocations.u_projectionMatrix,
                !1,
                this.projectionMatrix,
              ),
              r.uniformMatrix4fv(
                L.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.uniformMatrix4fv(
                L.uniformLocations.u_referenceProjectionViewMatrix,
                !1,
                F,
              ),
              r.uniform1f(L.uniformLocations.u_time, t),
              r.uniform1f(
                L.uniformLocations.u_intensity,
                this.backgroundIntensity.evaluate(),
              ),
              r.uniform1f(L.uniformLocations.u_zoom, 1),
              r.uniform2f(
                L.uniformLocations.u_fov,
                (this.currentVerticalFOV * this.canvas.width) /
                  this.canvas.height,
                this.currentVerticalFOV,
              ),
              r.uniform1f(
                L.uniformLocations.u_transitionT,
                this.backgroundTransitionT.evaluate(),
              ),
              r.uniform1f(
              ...
              r.uniform2f(
                L.uniformLocations.u_screenResolution,
                this.canvas.width,
                this.canvas.height,
              ),
              r.uniform2f(
              ...
              r.uniform3fv(
                this.floorProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.floorProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.uniform1f(
                this.floorProgram.uniformLocations.u_yOffset,
                this.floorYOffset.evaluate(),
              ),
              r.enable(r.DEPTH_TEST),
              r.enable(r.BLEND),
            ...
            if (
              ...
              r.uniform3fv(
                this.dustProgram.uniformLocations.u_cameraPosition,
                this.cameraPosition,
              ),
              r.uniformMatrix4fv(
              ...
              r.uniformMatrix4fv(
                this.dustProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.uniform1f(
                this.dustProgram.uniformLocations.u_scale,
                this.dustScale.evaluate(),
              ),
              ...
              if (
                ...
                this.festiveScene.snow.update(
                  n,
                  this.festiveParticleSpawnRate,
                  D,
                );
                ...
                (r.depthMask(!1),
                  ...
                  r.uniform3fv(
                    O.uniformLocations.u_cameraPosition,
                    this.cameraPosition,
                  ),
                  r.uniformMatrix4fv(
                  ...
                  r.uniformMatrix4fv(
                    O.uniformLocations.u_viewMatrix,
                    !1,
                    this.viewMatrix,
                  ),
                  r.uniform1f(
                    O.uniformLocations.u_time,
                    this.festiveScene.snow.time,
                  ),
                  r.uniform1f(
                    O.uniformLocations.u_transitionT,
                    this.festiveParticleTransitionT,
                  ),
                  r.uniform1f(
                    O.uniformLocations.u_offset,
                    this.festiveParticleOffset,
                  ),
                  r.enableVertexAttribArray(0),
                  r.enableVertexAttribArray(1),
                  r.enableVertexAttribArray(2),
              ...
              (G.update(n, this.festiveParticleSpawnRate, D),
                ...
                r.uniform3fv(
                  N.uniformLocations.u_cameraPosition,
                  this.cameraPosition,
                ),
                r.uniformMatrix4fv(
                  N.uniformLocations.u_projectionMatrix,
                  !1,
                  this.projectionMatrix,
                ),
                r.uniformMatrix4fv(
                  N.uniformLocations.u_viewMatrix,
                  !1,
                  this.viewMatrix,
                ),
                r.uniform1f(N.uniformLocations.u_time, G.time),
                r.uniform1f(
                  N.uniformLocations.u_transitionT,
                  this.festiveParticleTransitionT,
                ),
                r.uniform1f(
                  N.uniformLocations.u_offset,
                  this.festiveParticleOffset,
                ),
                r.enableVertexAttribArray(0),
                r.enableVertexAttribArray(1),
              ...
              for (P = this.festiveScene.poppers.length - 1; P >= 0; --P)
                t - this.festiveScene.poppers[P].spawnTime > 20 &&
                  (this.festiveScene.poppers[P].destroy(),
                  this.festiveScene.poppers.splice(P, 1));
              (r.depthMask(!1),
                r.enable(r.DEPTH_TEST),
                r.enable(r.BLEND),
                r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA),
                ...
                r.uniform3fv(
                  H.uniformLocations.u_cameraPosition,
                  this.cameraPosition,
                ),
                r.uniformMatrix4fv(
                  H.uniformLocations.u_projectionMatrix,
                  !1,
                  this.projectionMatrix,
                ),
                r.uniformMatrix4fv(
                  H.uniformLocations.u_viewMatrix,
                  !1,
                  this.viewMatrix,
                ),
                r.uniform1f(H.uniformLocations.u_time, t),
                r.uniform1f(
                  H.uniformLocations.u_transitionT,
                  this.festiveParticleTransitionT,
                ),
                r.uniform1f(
                  H.uniformLocations.u_offset,
                  this.festiveParticleOffset,
                ),
                r.enableVertexAttribArray(0),
                r.enableVertexAttribArray(1),
                ...
                r.enableVertexAttribArray(3));
              for (
                var U = 0, V = this.festiveScene.poppers;
                U < V.length;
                U++
              ) {
                var Y = V[U];
                (r.uniform3fv(
                  H.uniformLocations.u_spawnPosition,
                  Y.spawnPosition,
                ),
            ...
            (r.bindFramebuffer(r.FRAMEBUFFER, null),
              ...
              r.uniformMatrix4fv(
                this.uiProgram.uniformLocations.u_viewMatrix,
                !1,
                this.viewMatrix,
              ),
              r.enableVertexAttribArray(0),
            ...
            Q < 1 &&
              ...
              r.uniform4f(
                this.colorProgram.uniformLocations.u_color,
                0,
                0,
                0,
                1 - Q,
          ...
          (e.prototype.generateBackgroundTexture = function (e, t) {
            ...
            return (
              ...
              n.uniform1i(
                this.compositeBackgroundProgram.uniformLocations
                  .u_backgroundTexture,
                0,
              ),
              ...
              n.uniform1i(
                this.compositeBackgroundProgram.uniformLocations.u_maskTexture,
                1,
              ),
    ...
    var xe = (function () {
        function e(e) {
          ...
          do {
            ((c += 1),
              Object(d.n)(n[c].name) && !Object(d.n)(n[c + 1].name)
                ? (this.chunks.push({ vowel: h, suffix: p }),
                  (h = n[c]),
                  (p = []))
        ...
        return (
          (e.prototype.update = function () {
            if (this.frames.length >= 2)
              ...
              this.secondsInCurrentFrame =
                this.timestepSeconds - this.delaySeconds;
          }),
      ...
      _e = (function () {
        function e(e) {
          ...
          for (var t = 0; t < e.length; ++t)
            ((this.fromValue[t] = e[t]), (this.targetValue[t] = e[t]));
        ...
        return (
          (e.prototype.change = function (e, t) {
            if (!Object(d.a)(this.targetValue, e)) {
              ...
              for (var n = 0; n < this.targetValue.length; ++n)
                this.targetValue[n] = e[n];
              ((this.tweenDuration = 1e3 * t),
        ...
        return (
          (e.prototype.evaluate = function (e) {
            var t = Math.floor(e),
              ...
              a = e % 1;
            return (
              0.188 * Object(d.q)(i * a, o * (a - 1), Object(d.v)(0, 1, a))
            );
          }),
          e
        );
    ...
    var Me,
      ...
      Ce = function (e, t, n) {
        ((this.module = t),
          (this.pointer = n),
          (this.vertexCount = this.module._rigidMeshGetVertexCount(
            this.pointer,
          )),
          (this.indexCount = this.module._rigidMeshGetIndexCount(
            this.pointer,
          )));
        var i = this.module.HEAPU16.subarray(
        ...
        return (
          ...
          (e.prototype.update = function () {
            v.a.fromAxisAngle(
              this.rotation,
              Te,
              0.53 + 0.5 * this.noise.evaluate(0.001 * this.frame),
            );
            var e = 0.05 * this.noise.evaluate(0.001 * this.frame + 200),
              t = 0.05 * this.noise.evaluate(0.001 * this.frame + 400);
            ((this.position[0] =
              this.worldAttachPoint[0] +
              Math.sin(e) * Math.cos(t) * this.restDistance),
              (this.position[1] =
                this.worldAttachPoint[1] + Math.cos(e) * this.restDistance),
              (this.position[2] =
                this.worldAttachPoint[2] +
                Math.sin(e) * Math.sin(t) * this.restDistance),
              Be(
                this.baseModelMatrix,
                this.position,
                this.rotation,
              ...
              c.transformPosition(
                this.attachPoint,
                this.worldAttachPoint,
                this.inverseBaseModelMatrix,
              ),
              (this.frame += 1));
          }),
          e
    ...
    var Ge = (function () {
        ...
        return (
          (e.prototype.getBuffersOfSize = function (e) {
            var t = e.toFixed(0);
            return (
              t in this.buffersBySize || (this.buffersBySize[t] = []),
              this.buffersBySize[t]
            );
          }),
          ...
          (e.prototype.getBuffer = function (e) {
            ...
            return (
              t.length > 0
                ? (n = t.pop())
                : ((this.buffersCreated += 1), (n = new ArrayBuffer(e))),
              n
            );
          }),
      ...
      He = (function () {
        ...
        return (
          ...
          (e.prototype.get = function () {
            ...
            for (var e = 0, t = 0; t < this.samples.length; ++t)
              e += this.samples[t];
          ...
          (e.prototype.singNote = function (e, t, n, i, o, a, r) {
              ...
              p = function (a, r, p, m, f, g, b) {
                for (var v = Ne(f, l), y = a; y < r; ++y) {
                  ...
                  for (var _ = o, w = [], P = 0; P < _; ++P) {
                    ...
                    (A.setPhoneme(f.name),
                      A.setPreviousPhoneme(m.name),
                      A.setNextPhoneme(g.name));
                    var T = (y * _ + P) / (v * _ - 1);
            ...
            for (var m = 0; m < this.currentChunk.suffix.length; ++m) {
              ...
              p(
                ...
                0 === m
                  ? this.currentChunk.vowel
                  : this.currentChunk.suffix[m - 1],
                f,
                m === this.currentChunk.suffix.length - 1
                  ? e.vowel
                  : this.currentChunk.suffix[m + 1],
                !1,
              );
    ...
    function Ye(e, t) {
      for (var n = 0; n < 4; ++n)
        if (!(t < Ve[n][0] || t > Ve[n][1]) && t > e[n]) return n;
    ...
    var Xe = (function () {
          ...
          (e.prototype.onNote = function (e) {
            ...
            (i > 0
              ...
              (this.timeout = window.setTimeout(function () {
                ...
                for (o = 0; o < 4; ++o)
                  if (r[o].pitch !== t.singingNotes[o].pitch)
                    if (0 === r[o].pitch) {
                      ...
                      (t.singers[o].singNote(
                        m,
                        t.singingNotes[o].pitch,
                        !0,
                        !1,
                        1,
                        0.1,
                ...
                ((t.singingNotes = r),
                  (t.lastActiveNotes = t.activeNotes.slice(0)));
              }, 50)));
          }),
          e
        );
      ...
      Ze = (function () {
        function e(e) {
          ((this.desiredNote = null),
            (this.singingNote = { pitch: 0, vowel: _.b.a }),
            (this.singer = e));
        }
        return (
          (e.prototype.onNote = function (e) {
            ...
            if (
              ...
              if (0 === this.desiredNote.pitch) {
                ...
                this.singer.singNote(
                  i,
                  this.singingNote.pitch,
                  !0,
                  !1,
                  1,
                  0.1,
    ...
    !(function () {
      function e(e) {
        ...
        for (var t = 0; t < e.length; ++t)
          this.channelControllers.push(new Ze(e[t]));
      }
      e.prototype.onNote = function (e) {
        e.channel < this.channelControllers.length &&
          this.channelControllers[e.channel].onNote(e);
      };
    })();
    !(function () {
      function e(e) {
          ...
          for (
            var o = (c = e.pitch) >= 72 ? 0 : c >= 60 ? 1 : c >= 48 ? 2 : 3,
              a = this.channelControllers.filter(function (e) {
                return (
                  o ===
                  e.singer.audioParameters.singers[e.singer.singerIndex]
                    .voiceType
                );
              }),
              r = !1,
      ...
      ht = (function () {
        function e(e, t, n, i, o, a, r, s, l, u, m, f, g, b, v, x, k) {
          ...
          ((this.stateChangeListeners = []),
            ...
            "Recording" === u.kind &&
              u.recording.theme !== y.Normal &&
              (this.festiveEnabled = !0),
            ...
            "Recording" === u.kind &&
              this.audio.synthRunner.setPans(
                this.audio.synthRunner.audioParameters.pans[0],
              ),
          ...
          if ("relative" === e.positioningMode) this.cameraPositions = nt(w);
            ...
            for (var P = 0; P < 4; ++P)
              this.cameraPositions.push(
                h.a.mix([], b.endCameraPosition, b.startCameraPosition, P / 3),
              );
          }
              ...
              var n = b.blobs[t],
                ...
                s = new I(
                  ...
                  r.synthRunner.audioParameters.voiceTypes[
                    r.synthRunner.audioParameters.singers[n.singerIndex]
                      .voiceType
                  ].scale,
                  f.blobSubdivisions,
                  b.blobs[t],
                ...
                u = new ke(
                  ...
                  r.synthRunner.audioParameters.scriptProcessorBufferSize /
                    r.sampleRate,
                );
          ...
          for (P = 0; P < this.blobs.length; ++P) {
            var z = this.audio.synthRunner.audioParameters,
              C =
                z.voiceTypes[
                  z.singers[this.blobs[P].blob.config.singerIndex].voiceType
                ].scale[3];
            this.singers.push(
              new Ue(
                P,
          ...
          if ("Default" === u.kind)
            ...
            ((this.state = Qe.Playing),
              ...
              (this.playing = !1));
            for (P = 0; P < this.blobs.length; ++P)
              this.blobs[P].blob.startFalling(10 * P);
          ...
          ((this.midiController = new $e(B)),
            this.resume(),
            e.skipTutorial && this.skipTutorial(10));
        }
        return (
              ...
              for (var i = 0; i < this.blobs.length; ++i) {
                ...
                if (o) {
                  ("Finished" === this.tutorialState.kind &&
                    (this.tutorialState.hasInteracted = !0),
                    (o.draggingRestPosition[1] -= 0.2),
                    (this.blobController = new O(
                      this.blobs[i].blob,
                      o.draggingRestPosition,
                    )),
          ...
          (e.prototype.update = function (e) {
            ...
            for (var r = 0; r < this.blobs.length; ++r) {
              ...
              s.hatOffset.evaluate() < 1
                ...
                : Date.now() - this.lastConfettiPopTime < 3e3
                  ? (this.blobs[r].blob.lookPosition =
                      this.blobs[r].overrideLookPosition)
              ...
              this.blobs[r].blob.isDragging
                ? ((this.blobs[r].silenced = !1),
                  ...
                  this.audio.synthRunner.addOverrideF0(
                    r,
                    Object(d.p)(
                      this.blobs[r].blob.liveMidiNote.evaluate() + Oe,
                    ),
                  ))
            ...
            if (null !== this.blobController) {
              ...
              if (
                ...
                if (this.state === Qe.Main)
                  if ("Pitch" === this.tutorialState.kind)
                    ((this.tutorialState.notesSung += 1),
                      m.currentPitchVowel.midiPitch !==
                        this.lastSungNote.midiPitch &&
                    ...
                    if (
                      ((this.tutorialState.notesSung += 1),
                      2 === this.tutorialState.notesSung)
                    ) {
                      var x = 0;
                ...
                (g && (this.firstNoteTime = v),
                  f < 4 &&
                    this.audio.synthRunner.setPans(
                      this.audio.synthRunner.audioParameters.pans[f],
                    ));
                var k =
                                      ...
                                      ? ("Empty" !== r.harmonizationTimeout &&
                                        ...
                                        (r.harmonizationTimeout =
                                          window.setTimeout(function () {
                                            var o = t.singers[f].previousChunk;
                                            if (
                                              !Object(d.a)(
                                                o.suffix.map(function (e) {
                                                  return e.name;
                                                }),
                                                t.singers[
                                                  a
                                              ...
                                              var s = {
                                                vowel: {
                                                  name: _.b.sil,
                                                  duration: o.vowel.duration,
                                                },
                                                suffix: o.suffix,
                                              };
                                              t.singers[a].singNote(
                                                s,
                                                t.singers[a].currentMidiNote,
                                                !0,
                                                !1,
                                                1,
                                              );
            ...
            if (this.state === Qe.Playing && this.playing) {
              var z = Math.max(
                0,
                (this.clock.getTimeMs() - this.playbackStartTime) / 1e3,
              );
              for (r = 0; r < this.blobs.length; ++r)
                for (
              ...
              (function (e, t) {
                for (var n = 0; n < t.length; ++n)
                  if (t[n] < e.parts[n].notes.length) return !1;
                return !0;
              })(
            ...
            for (r = 0; r < this.blobs.length; ++r) {
              ...
              this.disableUI
                ? U.visible &&
                  (U.element.classList.remove("visible"), (U.visible = !1))
                : U.visible ||
                  (U.element.classList.add("visible"), (U.visible = !0)),
                this.blobs[r].silenced
                  ? U.silenced ||
                    (U.element.classList.add("silenced"), (U.silenced = !0))
                  : U.silenced &&
            ...
            if (
              (this.rendererPadding.change(
                this.state === Qe.Playing ? 60 : 0,
                1,
              ),
              (this.renderer.paddingHeight = Math.round(
                this.rendererPadding.evaluate(),
              )),
              ...
              this.pitchPrompt.visible ||
                (this.pitchPrompt.element.classList.add("visible"),
                (this.pitchPrompt.visible = !0));
              ...
              (this.pitchPrompt.text !== Y &&
                ...
                s.pitchUI.currentSoundedValue === s.pitchUI.currentDraggedValue
                  ? this.pitchPrompt.sounding ||
                    (document
                      .getElementById("pitch-prompt-pitch")
                      .classList.add("sounding"),
                    (this.pitchPrompt.sounding = !0))
                  : this.pitchPrompt.sounding &&
                    (document
                      .getElementById("pitch-prompt-pitch")
                      .classList.remove("sounding"),
                    (this.pitchPrompt.sounding = !1)));
            } else
              this.pitchPrompt.visible &&
                (this.pitchPrompt.element.classList.remove("visible"),
                (this.pitchPrompt.visible = !1));
            if (
              ...
              this.vowelPrompt.visible ||
                (this.vowelPrompt.element.classList.add("visible"),
                (this.vowelPrompt.visible = !0));
              ((s = this.blobController.blob),
              ...
              (this.vowelPrompt.text !== q &&
                ((document.getElementById("vowel-prompt-vowel").innerText =
                  Object(_.c)(s.vowelUI.currentDraggedValue)),
                (this.vowelPrompt.text = q)),
                this.positionElementWorld(
                  this.vowelPrompt.element,
                  V,
                  "center",
                  "bottom",
                ),
                s.vowelUI.currentSoundedValue === s.vowelUI.currentDraggedValue
                  ? this.vowelPrompt.sounding ||
                    (document
                      .getElementById("vowel-prompt-vowel")
                      .classList.add("sounding"),
              ...
              this.vowelPrompt.visible &&
                (this.vowelPrompt.element.classList.remove("visible"),
                (this.vowelPrompt.visible = !1));
            this.state !== Qe.Main ||
              this.isDraggingBlob() ||
              (this.cameraPosition.change(
                this.cameraPositions[this.getUnlockedVoiceIndex()],
                1.5,
              ),
              "Finished" !== this.tutorialState.kind &&
                ("Pitch" === this.tutorialState.kind &&
                this.tutorialState.pitchesChanged >= 4
                  ? (this.tutorialState = {
                      kind: "Vowel",
                      vowelsChanged: 0,
                      notesSung: 0,
                  ...
                  : "Vowel" === this.tutorialState.kind &&
                      this.tutorialState.vowelsChanged >= 3
                    ? (this.tutorialState = {
                        kind: "Harmonization",
                        notesHarmonized: 0,
                        notesSung: 0,
                    ...
                    : "Harmonization" === this.tutorialState.kind &&
                        this.tutorialState.notesSung >= 2
            ...
            for (r = 0; r < this.blobs.length; ++r)
              ...
              ("Pitch" === this.tutorialState.kind ||
                ...
                r !== this.blobs.length - 1
                  ? (2 === r &&
                      this.blobs[r].blob.vowelUI.yOffset.change(2.7, 0),
                    this.blobs[r].blob.pitchUI.overrideAlpha.change(0, 0.5))
                  : (r >= 2 &&
                      this.blobs[r].blob.vowelUI.yOffset.change(0, 1, 0),
            ...
            (this.cameraPosition.evaluate(this.cameraPositionCache),
              ...
              (this.renderer.festiveParticleSpawnRate =
                this.festiveParticlesSpawnRate.evaluate()),
              (this.renderer.festiveParticleTransitionT =
                this.festiveParticleTransitionT.evaluate()),
              this.festiveTheme === y.NewYears &&
                (this.festiveEnabled
                  ? this.balloonsOffset.change(0, 3)
                  : this.balloonsOffset.change(1, 3),
                (this.renderer.balloonsYOffset =
                  this.balloonsOffset.evaluate())));
            var W = [];
            for (r = 0; r < this.blobs.length; ++r)
              (W.push(this.blobs[r].blob),
                null !== this.blobs[r].oldBlob &&
                  W.push(this.blobs[r].oldBlob));
            ...
            if (((this.blobs[e].lastSentF0 = t.getF0()), 1 !== t.getSkip())) {
              if (!this.blobs[e].silenced)
                for (o = 0; o < n.length; ++o) {
                  ...
                  (Object(d.d)(n[o].buffer, i),
                    this.blobs[e].frameTracker.addFrame(new ve.a(i)));
                }
              if (!this.blobs[e].silenced && !this.audio.isMuted()) {
                this.audio.synthRunner.addSpectralFrame(e, t);
                for (o = 0; o < n.length; ++o)
                  this.audio.synthRunner.addExcitationFrame(e, n[o]);
              }
            } else {
              this.bufferPool.returnBuffer(t.buffer);
              for (var o = 0; o < n.length; ++o)
                this.bufferPool.returnBuffer(n[o].buffer);
            }
          }),
          (e.prototype.sendSilence = function (e) {
            ...
            (a(n),
              n.setSubsteps(this.substeps[e]),
              n.setSendTime(Date.now() - this.epoch));
            var r = [];
            for (o = 0; o < 1; ++o) {
          ...
          (e.prototype.setAudioParameters = function (e) {
            (this.audio.synthRunner.setAudioParameters(e),
              this.voiceNet.setParameters(e));
          }),
            ...
            if (this.suspended) {
              ...
              var t = !0,
                ...
                i = function (o) {
                  var a = t ? 1e3 / 60 : o - n;
                  (e.update(a),
                    (e.requestedFrame = requestAnimationFrame(i)),
                    (n = o),
                    t && (t = !1));
                };
              ((this.requestedFrame = requestAnimationFrame(i)),
                (this.suspended = !1));
            }
          }),
          ...
          (e.prototype.enterPlaying = function (e) {
            if (this.state === Qe.Main) {
              for (var t = 0; t < this.getUnlockedVoiceIndex(); ++t)
                this.blobs[t].blob.state !== E.Idle &&
                  this.blobs[t].blob.startFalling(10 * t);
            ...
            return (
              (function (e, t) {
                for (var n = 1 / 0, i = 0, o = e.parts; i < o.length; i++) {
                  (l = o[i]).notes.length > 0 &&
                    (n = Math.min(n, l.notes[0].timeSeconds));
                }
          ...
          (e.prototype.togglePlayback = function () {
            this.state === Qe.Playing &&
              (this.playing ? this.stopPlayback() : this.startPlayback(0));
          }),
          (e.prototype.startPlayback = function (e) {
            if (this.state === Qe.Playing) {
              ((this.playing = !0),
                (this.playbackStartTime = this.clock.getTimeMs() + 1e3 * e));
          ...
          (e.prototype.stopPlayback = function () {
            if (this.state === Qe.Playing && this.playing) {
              this.playing = !1;
              for (
                var e = this.libretto.getNextChunk(_.b.sil), t = 0;
                t < this.blobs.length;
                ++t
              )
                this.singers[t].currentMuted ||
                  this.singers[t].singNote(
                    e,
                    this.singers[t].currentMidiNote,
                    !0,
                    !1,
                    1,
                  );
          ...
          (e.prototype.skipTutorial = function (e) {
            if ((void 0 === e && (e = 0), this.state === Qe.Main)) {
              if (!this.config.disableDrop) {
                for (
                  var t = e, n = this.getUnlockedVoiceIndex() - 1;
                  n >= 0;
                  n -= 1
                )
                  (this.blobs[n].blob.startFalling(t), (t += 10));
                for (n = 4; n < this.blobs.length; ++n)
                  (this.blobs[n].blob.startFalling(t), (t += 10));
              }
          ...
          (e.prototype.setScene = function (e, t) {
            for (
              ...
              this.blobs[i].oldBlob &&
                (this.blobs[i].oldBlob.destroy(),
                (this.blobs[i].oldBlob = null));
              var o = e.blobs[i],
                a =
          ...
          (e.prototype.popConfetti = function () {
            (this.renderer.popConfetti(),
              (this.lastConfettiPopTime = Date.now()));
        ...
        function (e) {
          ...
          ((a = null),
            ...
            "object" != typeof WebAssembly &&
              C("no native wasm support detected"));
          var p = !1;
          function m(e) {
            var t,
              n = i["_" + e];
          ...
          function k(e, t, n) {
            ...
            if (o - t > 16 && e.subarray && x)
              return x.decode(e.subarray(t, o));
            for (var a = ""; t < o; ) {
              var r = e[t++];
              if (128 & r) {
                var s = 63 & e[t++];
          ...
          function Y(e) {
            try {
              return (
                c.grow((e - g.byteLength + 65535) >>> 16),
                w(c.buffer),
                1
              );
            } catch (e) {}
          ...
          var q,
                ...
                for (var n, i, o = 1; o <= 4; o *= 2) {
                  ...
                  if (
                    ...
                    Y(
                      Math.min(
                        2147483648,
                        ((n = Math.max(16777216, e, a)) % (i = 65536) > 0 &&
                          (n += i - (n % i)),
                        n),
                      ),
                    ))
            ...
            K =
                  ...
                  ((i.asm = n),
                    ...
                    (function (e) {
                      if (
                        ...
                        0 == M &&
                          (null !== R && (clearInterval(R), (R = null)), z))
                      ) {
                        var t = z;
                        ((z = null), t());
                      }
              ...
              (i.___wasm_call_ctors = function () {
                return (K = i.___wasm_call_ctors = i.asm.h).apply(
                  null,
                  arguments,
                );
              })),
            X =
              ...
              (i._blobGetRestMouthCentroid = function () {
                return (i._blobGetRestMouthCentroid = i.asm.n).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthCentroid = function () {
                return (i._blobGetMouthCentroid = i.asm.o).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobGetRestPositions = function () {
                return (i._blobGetRestPositions = i.asm.s).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobGetRenderingVertexCount = function () {
                return (i._blobGetRenderingVertexCount = i.asm.x).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingPositions = function () {
                return (i._blobGetRenderingPositions = i.asm.y).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingNormals = function () {
                return (i._blobGetRenderingNormals = i.asm.z).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingUVs = function () {
                return (i._blobGetRenderingUVs = i.asm.A).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingSpeeds = function () {
                return (i._blobGetRenderingSpeeds = i.asm.B).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingIndices = function () {
                return (i._blobGetRenderingIndices = i.asm.C).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetRenderingIndexCount = function () {
                return (i._blobGetRenderingIndexCount = i.asm.D).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthTriangleIndexCount = function () {
                return (i._blobGetMouthTriangleIndexCount = i.asm.E).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthTriangleIndices = function () {
                return (i._blobGetMouthTriangleIndices = i.asm.F).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthPositionCount = function () {
                return (i._blobGetMouthPositionCount = i.asm.G).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthPositions = function () {
                return (i._blobGetMouthPositions = i.asm.H).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobSetMouthDamping = function () {
                return (i._blobSetMouthDamping = i.asm.L).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobSetMouthRotation = function () {
                return (i._blobSetMouthRotation = i.asm.O).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobSetMouthNoiseScale = function () {
                return (i._blobSetMouthNoiseScale = i.asm.P).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobSetMouthNoiseOffset = function () {
                return (i._blobSetMouthNoiseOffset = i.asm.Q).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobSetMouthNoiseFrequency = function () {
                return (i._blobSetMouthNoiseFrequency = i.asm.R).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobSetNoiseParameters = function () {
                return (i._blobSetNoiseParameters = i.asm.T).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobSetBreathVolumeScale = function () {
                return (i._blobSetBreathVolumeScale = i.asm.U).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetIntersectedRestPosition = function () {
                return (i._blobGetIntersectedRestPosition = i.asm.V).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._blobGetMouthProfilePositions = function () {
                return (i._blobGetMouthProfilePositions = i.asm.Y).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthProfileNormals = function () {
                return (i._blobGetMouthProfileNormals = i.asm.Z).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthProfileUVs = function () {
                return (i._blobGetMouthProfileUVs = i.asm._).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthProfileIndices = function () {
                return (i._blobGetMouthProfileIndices = i.asm.$).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthProfileIndexCount = function () {
                return (i._blobGetMouthProfileIndexCount = i.asm.aa).apply(
                  null,
                  arguments,
                );
              }),
              (i._blobGetMouthProfileVertexCount = function () {
                return (i._blobGetMouthProfileVertexCount = i.asm.ba).apply(
                  null,
                  arguments,
                );
              }),
              (i._tongueGetPointCount = function () {
                return (i._tongueGetPointCount = i.asm.ca).apply(
                  null,
                  arguments,
                );
              }),
              (i._tongueGetPositions = function () {
                return (i._tongueGetPositions = i.asm.da).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._tongueSetWindForce = function () {
                return (i._tongueSetWindForce = i.asm.ga).apply(
                  null,
                  arguments,
                );
              }),
              (i._tongueSetOscillationScale = function () {
                return (i._tongueSetOscillationScale = i.asm.ha).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._eyeGetRestPositions = function () {
                return (i._eyeGetRestPositions = i.asm.ka).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._eyeGetCenterPosition = function () {
                return (i._eyeGetCenterPosition = i.asm.na).apply(
                  null,
                  arguments,
                );
              }),
              (i._eyeGetAttachPosition = function () {
                return (i._eyeGetAttachPosition = i.asm.oa).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._hatGetBrimPositions = function () {
                return (i._hatGetBrimPositions = i.asm.wa).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._rigidMeshGetVertexCount = function () {
                return (i._rigidMeshGetVertexCount = i.asm.ya).apply(
                  null,
                  arguments,
                );
              }),
              (i._rigidMeshGetPositions = function () {
                return (i._rigidMeshGetPositions = i.asm.za).apply(
                  null,
                  arguments,
                );
              }),
              (i._rigidMeshGetNormals = function () {
                return (i._rigidMeshGetNormals = i.asm.Aa).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (i._rigidMeshGetTangents = function () {
                return (i._rigidMeshGetTangents = i.asm.Ca).apply(
                  null,
                  arguments,
                );
              }),
              (i._rigidMeshGetIndices = function () {
                return (i._rigidMeshGetIndices = i.asm.Da).apply(
                  null,
                  arguments,
                );
              }),
              (i._rigidMeshGetIndexCount = function () {
                return (i._rigidMeshGetIndexCount = i.asm.Ea).apply(
                  null,
                  arguments,
                );
              }),
              (i._rigidMeshGetBottomPoint = function () {
                return (i._rigidMeshGetBottomPoint = i.asm.Fa).apply(
                  null,
                  arguments,
                );
              }),
      ...
      ft = (function () {
        ...
        return function (t) {
                        ...
                        for (var a = ""; t < o; ) {
                          ...
                          if (128 & r) {
                            ...
                            if (192 != (224 & r)) {
                              ...
                              a += String.fromCharCode(((31 & r) << 6) | s);
                          } else a += String.fromCharCode(r);
                        }
                        return a;
                      })(v, n, i)
          ...
          function U(e) {
            try {
              return (
                h.grow((e - g.byteLength + 65535) >>> 16),
                k(h.buffer),
                1
              );
            } catch (e) {}
          ...
          var V,
            ...
            q =
                  ...
                  ((o.asm = n),
                    ...
                    (function (e) {
                      if (
                        ...
                        0 == T &&
                          (null !== E && (clearInterval(E), (E = null)), M))
                      ) {
                        var t = M;
                        ((M = null), t());
                      }
                    ...
                    c || "function" != typeof fetch
                      ...
                      : fetch(B, { credentials: "same-origin" })
                          .then(function (e) {
                            if (!e.ok)
                              throw (
                                "failed to load wasm binary file at '" + B + "'"
                              );
                            return e.arrayBuffer();
                          })
                          .catch(function () {
              ...
              (o.___wasm_call_ctors = function () {
                return (q = o.___wasm_call_ctors = o.asm.g).apply(
                  null,
                  arguments,
                );
              })),
            W =
              ...
              (o._synthHasEnoughExcitationFrames = function () {
                return (o._synthHasEnoughExcitationFrames = o.asm.k).apply(
                  null,
                  arguments,
                );
              }),
              (o._synthHasEnoughSpectralFrames = function () {
                return (o._synthHasEnoughSpectralFrames = o.asm.l).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (o._voiceAddSpectralFrame = function () {
                return (o._voiceAddSpectralFrame = o.asm.o).apply(
                  null,
                  arguments,
                );
              }),
              (o._voiceAddExcitationFrame = function () {
                return (o._voiceAddExcitationFrame = o.asm.p).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (o._createSpectralFrame = function () {
                return (o._createSpectralFrame = o.asm.r).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (o._spectralFrameGetSpectrogram = function () {
                return (o._spectralFrameGetSpectrogram = o.asm.t).apply(
                  null,
                  arguments,
                );
              }),
              (o._createExcitationFrame = function () {
                return (o._createExcitationFrame = o.asm.u).apply(
                  null,
                  arguments,
                );
              }),
              (o._excitationFrameReset = function () {
                return (o._excitationFrameReset = o.asm.v).apply(
                  null,
                  arguments,
                );
              }),
              (o._excitationFrameGetAperiodic = function () {
                return (o._excitationFrameGetAperiodic = o.asm.w).apply(
                  null,
                  arguments,
                );
              }),
              (o._excitationFrameGetPeriodic = function () {
                return (o._excitationFrameGetPeriodic = o.asm.x).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (o._createReverbContext = function () {
                return (o._createReverbContext = o.asm.A).apply(
                  null,
                  arguments,
                );
              }),
              (o._createDCReverbContext = function () {
                return (o._createDCReverbContext = o.asm.B).apply(
                  null,
                  arguments,
                );
              }),
              (o._reverbContextProcess = function () {
                return (o._reverbContextProcess = o.asm.C).apply(
                  null,
                  arguments,
                );
              }),
              ...
              (o._synthBenchmarkSpectrumGeneration = function () {
                return (o._synthBenchmarkSpectrumGeneration = o.asm.E).apply(
                  null,
                  arguments,
                );
              }),
    ...
    var _t = (function () {
      ...
      wt = (function () {
        function e(e, t, n, i, o, a, r, s, l, u) {
          ...
          ((this.runningAverage = new _t(h)),
            (this.bufferSize = l.scriptProcessorBufferSize));
        }
        return (
          (e.prototype.start = function () {
            ...
            ((this.scriptNode.onaudioprocess = function (n) {
              var i = [
                  n.outputBuffer.getChannelData(0),
                  n.outputBuffer.getChannelData(1),
                ],
                o = performance.now();
    ...
    function St(e, t, i, o, a) {
      ...
      for (
        var s = e.sampleRate / r, l = 0, u = 0;
        u < Pt.length && !((l = Pt[u]) <= s);
        ++u
      );
      ...
      return (
        (h =
          ...
          (!navigator.userAgent.includes("Chrome/89") &&
            !navigator.userAgent.includes("Chrome/90")) ||
          yt()
        ...
        Promise.all([h, At(e, "applause", "applause.mp3")]).then(
          function (t) {
      ...
      function e(e) {
        ...
        ((this.queuedPromises = []),
          ...
          (this.worker.onmessage = function (e) {
            var n = e.data;
            "Notes" === n.type &&
              (t.queuedPromises[0](n.notes), t.queuedPromises.splice(0, 1));
          }));
      }
      return (
    ...
    function zt(e, t) {
      for (var n = [], i = 0; i < t; ++i)
        n.push(new Worker(Object(gt.a)("voicenetworker.js" + Object(kt.a)())));
      return Promise.all([
    ...
    for (var Ht = 1; Ht < Dt.length; ++Ht)
      for (var Ut = Dt[Ht], Vt = Ut[0], Yt = 0; Yt < Ot.length; ++Yt)
        Lt[Ot[Yt]][Vt] = Ut[1 + Yt];
    var qt = (function () {
        var e = function (t, n) {
          return (e =
        ...
        Promise.all(
          n.blobs.map(function (n) {
            return (function (e, t, n) {
              ...
              return Promise.all([
                e.load(Object(gt.a)(n.modelPath)),
                Xt(t, n.body),
              ]).then(function (e) {
                return {
                  meshBuffer: e[0],
    ...
    function en(e) {
      e.predicate()
        ? e.hasClass ||
          (e.element.classList.add(e.className), (e.hasClass = !0))
        : e.hasClass &&
          (e.element.classList.remove(e.className), (e.hasClass = !1));
    }
    var tn,
      nn = (function () {
        function e() {
    ...
    var rn = (function () {
        function e(e, t, n, i, o, a, r) {
          ...
          ((this.controlledElements = new nn()),
            ...
            (this.textureCache = r),
            (this.environment = n),
            (this.environment.onLocationChange =
            ...
            (this.festiveConfig =
              (l = i.festiveTheme) === y.Christmas
                ? {
                    ...
                    songs: [
                      {
                        recordingID: "jinglebells",
                        nameStringID: "song_jingle_bells",
                      },
                      {
                        recordingID: "silentnight",
                        nameStringID: "song_silent_night",
                      },
                      {
                        recordingID: "joytotheworld",
                        nameStringID: "song_joy_to_the_world",
                      },
                      {
                      ...
                      {
                        recordingID: "thefirstnoel",
                        nameStringID: "song_the_first_noel",
                      },
                      {
                ...
                : l === y.NewYears
                  ? {
                      ...
                      songs: [
                        {
                          recordingID: "auldlangsyne",
                          nameStringID: "song_auld_lang_syne",
                        },
                      ],
                    }
                  : { kind: y.Normal }),
          ...
          var c = document.getElementById("skip"),
            h = function () {
              (u.opera.skipTutorial(),
                u.environment.track({ action: "skip-tutorial" }));
            };
          (c.addEventListener("click", h),
              ...
              .addEventListener("click", function () {
                if (u.opera.isRecording) u.endRecording();
                  ...
                  ("Loaded" === u.locationState.kind &&
                    (e =
                      "location_blobpera_house" ===
                      (t = u.locationState.locationStringID)
                        ? x.BlobperaHouse
                        : "location_london" === t
                          ? x.London
                          : "location_new_york" === t
            ...
            document
              .getElementById("save")
              .addEventListener("click", this.saveRecording.bind(this)),
            document
              .getElementById("startstop")
              .addEventListener(
                "click",
                this.opera.togglePlayback.bind(this.opera),
              ),
            document
              .getElementById("play")
              .addEventListener("click", function () {
              ...
              .addEventListener("click", function () {
                (u.opera.enterMain(),
                  ...
                  "Previewing" === u.saveState.kind &&
                    u.environment.track({ action: "tap-discard" }),
                  u.environment.track({
                    action: "tap-back",
                    label:
                      "Saved" === u.saveState.kind
                        ? u.saveState.savedRecordingID
                        : "",
                  }));
              }),
            document
          ...
          (document
            .getElementById("location-playlist-button")
            .addEventListener("click", d),
            document
              .getElementById("location-playlist-button")
              .addEventListener("touchend", d),
            document
              .getElementById("location-selector-button")
              .addEventListener("click", p),
            document
              .getElementById("location-selector-button")
              .addEventListener("touchend", p));
          var m = function (e) {
            (e.stopPropagation(),
              e.preventDefault(),
              (u.showingFestivePlaylist = !1),
          ...
          (t.canvas.addEventListener("click", m),
            ...
            document
              .getElementById("performance-warning-dismiss")
              .addEventListener("click", function (e) {
          ...
          (this.controlledElements
            ...
            .add("#muted-container", "visible", function () {
              return (
                t.state === Qe.Playing && t.audio.isMuted() && !t.suspended
              );
            })
            ...
            this.festiveConfig.kind === y.Christmas
              ? (document
                  .querySelector("#festive-switch-container")
                  .classList.add("christmas"),
                (document.querySelector("#festive-prompt").innerHTML =
                  this.localiseString("prompt_festive")))
              : this.festiveConfig.kind === y.NewYears &&
                (document
                  .querySelector("#festive-switch-container")
                  .classList.add("newyears"),
                (document.querySelector("#festive-prompt").innerHTML =
                  this.localiseString("prompt_newyear"))),
            (this.festiveToggle = document.querySelector(
              "input[name=festive]",
            )),
            t.festiveEnabled &&
              this.festiveToggle.setAttribute("checked", "true"),
              ...
              (u.festiveToggle.checked
                ? t.festiveEnabled ||
                  ...
                  u.festiveConfig.kind === y.NewYears
                    ? u.opera.popConfetti()
                    : u.festiveConfig.kind === y.Christmas &&
                      u.opera.jingleBells(),
                  b() && (u.showingFestivePlaylist = !0))
                : (t.festiveEnabled && u.opera.setFestiveEnabled(!1),
                  (u.showingFestivePlaylist = !1)),
                (u.showingLocationSelector = !1),
                u.environment.track({
                  action: "tap-christmas-logo",
                  label: on(u.opera.state),
                }));
            }),
                  ...
                  an("place", Lt[o][e.locationStringID], "", function (t) {
                    (t.stopPropagation(),
                      ("None" !== u.locationState.kind &&
                        e.locationStringID ===
                          u.locationState.locationStringID) ||
                        (u.opera.enterMain(),
          ...
          ((t.onBlobInteraction = function (e) {
            u.environment.track({
              ...
              label:
                ...
                on(u.opera.state) +
                ("Saved" === u.saveState.kind
                  ? "_" + u.saveState.savedRecordingID
                  : ""),
            });
          }),
            ...
            document.querySelectorAll(".button-text").forEach(function (e) {
              e.scrollWidth > e.clientWidth &&
                e.classList.add("button-text-small");
            }));
          var E = function (e) {
        ...
        return (
          ...
          (e.prototype.onStateChange = function (e) {
            (e === Qe.Main && (this.saveState = { kind: "None" }),
              e === Qe.Main &&
                this.environment.changeLocation({ kind: "Default" }));
          }),
            ...
            return "Saved" === e.kind &&
              ...
              ? this.localiseString("axl_share_recording_cc")
                  .replace(
                    "<song>",
                    this.localiseString(
                      this.findLocationSong(e.savedRecordingID).nameStringID +
                        "_name",
                    ),
                  )
                  .replace(
              ...
              : "Saved" === e.kind && e.recordingType === tn.Festive
                ? this.localiseString("axl_share_festive_recording_cc").replace(
                    "<song>",
                    this.localiseString(
                      this.findFestiveSong(e.savedRecordingID).nameStringID +
                        "_name",
                    ),
                  )
                : "Loaded" === this.locationState.kind
            ...
            "Previewing" === this.saveState.kind
              ? ((this.saveState = { kind: "SaveRequested" }),
                ...
                this.backend
                  ...
                  .then(function (n) {
                    ((e.saveState = {
                      kind: "Saved",
                      savedRecordingID: n.id,
                      recordingType: tn.UGC,
                    }),
                      e.environment.changeLocation({
                        kind: "Recording",
                        recordingID: n.id,
                      }),
                      e.environment.share(
                        {
                          kind: "Recording",
                          recordingID: e.saveState.savedRecordingID,
                        },
                        t,
                      ),
                      e.environment.track({
              ...
              : "Saved" === this.saveState.kind &&
                ...
                this.environment.share(
                  {
                    kind: "Recording",
                    recordingID: this.saveState.savedRecordingID,
                  },
                  t,
                ),
                this.environment.track({
                  action: "tap-share",
                  label: this.saveState.savedRecordingID,
                }));
			*/
          }),
          (e.prototype.update = function (e) {
                  ...
                  (function (e) {
                    for (var t = 0, n = 0, i = e.parts; n < i.length; n++) {
                      ...
                      o.notes.length > 0 &&
                        (t = Math.max(
                          t,
                          o.notes[o.notes.length - 1].timeSeconds,
                        ));
                    }
                    return t;
                  })(t.playingRecording),
            ...
            if (this.opera.isRecording) {
              c = Math.max(
                0,
                (t.clock.getTimeMs() - t.recordingStartTime) / 1e3,
              );
              p.innerText = $t(c);
            }
                ...
                this.backend
                  ...
                  .then(function (n) {
                    (t.opera.enterPlaying(n),
                      t.isAtBlobperaHouse() &&
                        ((n.theme === y.Christmas &&
                          t.festiveConfig.kind === y.Christmas) ||
                        (n.theme === y.NewYears &&
                          t.festiveConfig.kind === y.NewYears)
          ...
          (e.prototype.getSelectedScene = function () {
            if ("None" === this.locationState.kind)
              return this.config.scenes[0];
          ...
          (e.prototype.updateMenus = function () {
            (this.rebuildLocationPlaylistMenu(),
              this.festiveConfig.kind !== y.Normal &&
                this.updatePlaylistMenuLoadStates(
                  "festive-songs",
                  this.festiveConfig.songs,
                ),
              this.updatePlaylistMenuLoadStates(
                "location-songs",
                this.getSelectedScene().songs || [],
              ),
              this.updateLocationMenuLoadStates());
          }),
          (e.prototype.rebuildLocationPlaylistMenu = function () {
            for (
              var e = document.getElementById("location-songs"),
                t = 0,
                n = [].slice.apply(e.childNodes);
              t < n.length;
              t++
            ) {
              n[t].remove();
              ...
              var i = this,
                o = function (t) {
                  var o = a.localiseString(t.nameStringID + "_name"),
                    r = n
                      ? a.localiseString(t.nameStringID + "_description")
                      : "";
                  e.appendChild(
          ...
          (e.prototype.updatePlaylistMenuLoadStates = function (e, t) {
            for (
              var n = document.getElementById(e).querySelectorAll("li"), i = 0;
              i < t.length;
              ++i
            ) {
              var o = t[i];
              (
                ...
                ? (n[i].classList.add("playing"),
                  (n[i].querySelector(".material-icons").innerHTML =
                    "volume_up"),
                  "Loading" === this.saveState.kind &&
                  this.saveState.loadingRecordingID === o.recordingID
          ...
          (e.prototype.updateLocationMenuLoadStates = function () {
            ...
            "None" !== this.locationState.kind
              ? ((i.innerText =
                  Lt[this.language][this.locationState.locationStringID]),
              ...
              a = o.handshake().then(function (e) {
                return (function (e) {
                  return "r" in e
                    ...
                    : "nye" in e
                      ? (alert("NYE"),
                        { kind: "Recording", recordingID: "jinglebells" })
                      : { kind: "Default" };
                })(e);
              }),
                ...
                function e(e, t) {
                  ...
                  ((this.onLocationChange = null),
                    ...
                    e.registerMessageCallback(
                      i.HostToChild.RESUME,
                      function () {
                        n.onResume && n.onResume();
                      },
                    ),
                    e.registerMessageCallback(
                      i.HostToChild.FREEZE,
                      function () {
                ...
                return (
                  ...
                  (e.prototype.share = function (e, t) {
                    (this.changeLocation(e),
                      "Recording" === e.kind &&
                        o.sendMessage(i.ChildToHost.SHARE, { title: t }));
                  }),
                  (e.prototype.openURL = function (e) {
    ...
    function xn(e, t) {
      ...
      if (n)
        for (var i = 0, o = n; i < o.length; i++) {
          ...
          e = e.replace(
            a,
            '<span id="info-link">' + t.info_performing_arts_link + "</span>",
          );
        }
      return (n && (e = bn(e)), e);
    }
    function kn(e, t) {
      ...
      if (n)
        for (var i = 0, o = n; i < o.length; i++) {
          ...
          ((r = (r = xn((r = yn((r = bn((r = vn(r)))))), t)).replace(
            "-",
            "&#8209;",
          )),
            (e = e.replace(a, r)));
    ...
    var wn = {
        ...
        scenes: [
          ...
          },
          {
            ...
            songs: [
              {
                nameStringID: "song_hallelujah_chorus",
                recordingID: "hallelujahchorus5",
              },
              {
                nameStringID: "song_londonderry_air",
                recordingID: "londonderryair1",
              },
          ...
          },
          {
            ...
            songs: [
              {
                nameStringID: "song_new_world_symphony",
                recordingID: "dvorak1",
              },
              {
                nameStringID: "song_down_to_the_river",
                recordingID: "downtotheriver1",
              },
              {
                nameStringID: "song_when_the_saints",
                recordingID: "whenthesaints4",
              },
              { nameStringID: "song_summertime", recordingID: "summertime3" },
              {
                nameStringID: "song_country_club",
                recordingID: "countryclub1",
              },
            ],
          },
          {
            ...
            songs: [
              {
                nameStringID: "song_dios_nunca_muera",
                recordingID: "diosnuncamuere2",
              },
          ...
          },
          {
            ...
            songs: [
              ...
              {
                nameStringID: "song_frere_jacques",
                recordingID: "frerejacques4",
              },
                  ...
                  : En && FormData.prototype.isPrototypeOf(e)
                    ...
                    : Sn && URLSearchParams.prototype.isPrototypeOf(e)
                      ...
                      : Mn &&
                        ...
                        : Mn &&
                            (ArrayBuffer.prototype.isPrototypeOf(e) || zn(e))
    ...
    function Wn(e, t) {
      return new Promise(function (n, i) {
        ...
        if (o.signal && o.signal.aborted)
          return i(new qn("Aborted", "AbortError"));
    ...
    function Zn() {
      return (
        "1" === new URLSearchParams(window.location.search).get("axl")
          ? gn()
          : Promise.resolve(new fn())
      ).then(function (e) {
        var t,
          n = e.location;
        return ((t = n),
        "Recording" === t.kind
          ...
          : Promise.resolve({ kind: "Default", festiveTheme: Xn() })).then(
          function (t) {
            return [e, t];
          },
        );
      ...
      return Zn().then(function (o) {
        ...
        return r.festiveTheme === y.NewYears
          ? Promise.all([
              Zt(oi, n, l),
              $n(t),
              At(i, "party", Object(gt.a)("party.mp3")),
            ]).then(function (e) {
              return {
                environment: a,
                initOptions: r,
          ...
          : r.festiveTheme === y.Christmas
            ? Promise.all([
                Zt(oi, n, l),
                At(i, "bells", Object(gt.a)("bells.mp3")),
              ]).then(function (e) {
                return {
                  environment: a,
                  initOptions: r,
        ...
        var i = {},
          ...
          a = function (e) {
            ...
            i[n] ||
              ...
              o.push(
                Object(mt.a)(
                  Object(gt.a)("assets/balloon_" + n + ".flat"),
                ).then(function (e) {
    ...
    if (
      ...
      (ei(
        ...
        yt() &&
          document
            .getElementById("silent-hint")
            .classList.add("silent-hint-show"));
      var si = function () {
          window.innerHeight < 400
            ? (bt()
                ? ((document.getElementById(
                    "landscape-warning-desktop",
                  ).style.display = "none"),
                  (document.getElementById(
          ...
          (function (e, t) {
            ...
            [
              ...
              new Promise(function (e, t) {
                var n = new Worker(
                  Object(gt.a)("harmonizerworker.js" + Object(kt.a)()),
                );
            ...
            vt() || yt()
              ? ((document.getElementById("loading-bar").className =
                  "loading-button"),
                document
